 ...
 *
 */
public class AssetApplyScrapProcessStriggerEvent extends ProcessStepTriggerEvent{
	public static final String zckpsubformkey="SUBFORM_GDZCZQGZBD";//固定资产卡片subformkey
	public AssetApplyScrapProcessStriggerEvent(UserContext uc, HashMap<String,Object> hash) {
		super(uc, hash);
	...
	public boolean execute(){
		...
		//管理状态（申请报废）
		hash.put("STATUS", StatusConstant.ZYKP_GLZTSQBF);
		//获取当前系统时间
		...
		//操作
		hashMap.put("ACTIONTYPE",StatusConstant.ZYKP_GLZTSQBF);
		//添加管理变更日期
		hashMap.put("RQ", date);
		//获取部门
