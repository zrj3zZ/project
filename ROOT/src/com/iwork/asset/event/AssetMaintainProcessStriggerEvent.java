 ...
 *
 */
public class AssetMaintainProcessStriggerEvent extends ProcessStepTriggerEvent{
	public static final String zckpsubformkey="SUBFORM_GDZCZQGZBD";//固定资产卡片subformkey
	public AssetMaintainProcessStriggerEvent(UserContext uc, HashMap<String,Object> hash) {
		super(uc, hash);
	...
	public boolean execute(){
		...
		/**以下要实现的业务是将维修流程中的详细信息插入到资源卡片中  2016-1-20-**/
		if(dataMap!=null){
			//获取资产卡片
			...
			//管理状态（维护中）
			hash.put("STATUS", StatusConstant.ZYKP_GLZTWHZ);
			//获取当前系统时间
			...
			//操作
			hashMap.put("ACTIONTYPE",StatusConstant.ZYKP_GLZTWHZ);
			//添加管理变更日期
			hashMap.put("RQ", date);
			//获取部门
