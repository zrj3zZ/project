...
<html>
			   ...
			   plot4 = $.jqplot('chart4',[s1],{
				   seriesDefaults: {
			           ...
			           rendererOptions: {
			               ...
			               intervals:[1000,<s:property value="maxM"/>*0.9,<s:property value="maxM"/>],
	...
	<body >
	<div id="calendar" style="color:#efefef">60</div>
		<div id="chart4" class="plot" style="width:350px;height:200px;"></div>
	</body>
	<script>
	setInterval(function() { 
		$.ajax({ url: "systemServerMonitorParams.action",success: function(data){
			setNum(data);
	      }});
		}, 60000);
	setInterval(function() { 
