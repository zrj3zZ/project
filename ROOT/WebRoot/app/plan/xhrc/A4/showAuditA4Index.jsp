...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>     		
	...
	var selectedNodes;
		...
		function bohui(id,instanceid){
			...
			var pageUrl = "sanbu_plan_zhjjsh_openA4Opinion.action?instanceid="+instanceid+"&id="+id;
		...
		function audit(){
			...
			var url = "sanbu_plan_zhjjsh_auditA4.action?instanceid="+instanceid+"&ids="+ids.join(',');
		 ...
		 <div >
		 	<table width="90%" style="margin:auto">
		 		<tr>
		 			...
		 			<td class="td_data"><s:property value="mainData.YSYF"/>月</td>
