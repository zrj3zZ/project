	...
	<div style="overflow:auto">
		<table WIDTH="100%" style="border:1px solid #efefef">
			...
			<s:iterator value="children"  id="inner" >
				...
				<a href="###" onclick="showht('<s:property value="#inner.HTBH"/>')"><s:property value="#inner.HTMC"/></a></TD>
				<TD ><s:property value="#inner.HTBH"/></TD>
				...
				<s:if test="#inner.BBZT=='A7'">
					<TD ><input type="text" name="FKLY" onChange="setfkly(<s:property value="#inner.id"/>,<s:property value="#inner.INSTANCEID"/>,this)" id="FKLY_<s:property value="#inner.id"/>" style="width:58px" value="<s:property value="#inner.FKLY"/>"/></TD>
				</s:if>
