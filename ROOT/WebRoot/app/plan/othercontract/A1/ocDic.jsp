	...
	$(document).ready(function(){
		...
		function doSetting(){
			...
			var instanceid = $("#instanceid").val();
	         var pageUrl="oc_saveOcMx_action.action?instanceid="+instanceid+"&ids="+ids.join(',');
...
<div region="center" border="false" style="padding:0px;padding-left:10px;overflow:no;scrolling:no;border-bottom:1px;">
			<table id="pj_grid"  style = "margin:auto;height:450px;width:560px;border:1px solid #fff" iconCls="icon-edit" singleSelect="false"	idField="ID" url="oc_getHtDic_action.action?instanceid=${instanceid}"} >
									<thead> 
										<tr> 
											<th field="CK" checkbox=true></th>
											<th field="ID" width="40">ID</th>
											<th field="INSTANCEID" width="40" ></th>
											<th field="HTMC" width="100" >合同名称</th>
											<th field="HTBH" width="100" align="left" >合同编号</th>
											<th field="HTJE" width="85" align="left" >合同金额</th>
											<th field="HTWFJE" width="80" align="center" >合同未付金额</th>
											<th field="HTYFJE" width="80" align="center" >合同已付金额</th>
										</tr>
									</thead>
						</table>
