  ...
  <head>  
    ...
    function save(){
      ...
      function validate(){
          ...
          var fieldTitle=$.trim($('#editForm_model_fieldTitle').val());//不能为空，不能超过100
                  var fieldDisplay=$.trim($('#editForm_model_statisticsType').val());//不能为空           
          ...
          if(fieldTitle==""){
           ...
           if(fieldDisplay==""){
              ...
              $('#editForm_model_statisticsType').focus();
              return false;             
          }
    ...
    <body class="easyui-layout">
      <div region="center" border="false" style="padding:3px;margin-bottom:5px;overflow-y:auto;">
           <s:form name="editForm" id="editForm" action="ireport_designer_statistics_save.action" theme="simple">
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                      <td class="td_title">字段ID：</td><td class="td_data">
                      <s:select headerKey="" headerValue="-----请统计字段----" listKey="fieldName" listValue="fieldTitle"  name="model.fieldName" list="%{grouplist}" cssStyle="font-size:12px;color:#0000FF;" theme="simple"></s:select>
                   ...
                   <tr>
                      <td class="td_title">统计类型：</td><td class="td_data">
                      <s:select label="统计类型：" name="model.statisticsType"  list="%{statisticsTypeList}" listKey="typeKey" listValue="typeValue"> 
