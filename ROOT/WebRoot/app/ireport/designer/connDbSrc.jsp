...
<html>
  <head>
	...
	var setting = {
					...
					async: {
						enable: true,
						url:"conn_design_showJSON.action",
						dataType:"json"
					},
					callback: {
	...
	function onAsyncSuccess(event, treeId, treeNode, msg){ 
	                    ...
	                    var node=tree.getNodesByParam('dataid',groupid,null);
  ...
  <body class="easyui-layout">
     <div region="center" style="padding:3px;border-top:0px;width:100%">					
					...
					<div>
                        ...
                        <div class="bottom">您当前选择的数据源为：<span style="font-size:13px;font-weight:bold;font-style:oblique;" id="formSel"></span></div>                       
