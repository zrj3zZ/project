...
<title>金鹰BPM流程绩效分析</title>
	...
	<SCRIPT type="text/javascript">
		...
		$(document).ready(function(){
			$.fn.zTree.init($("#treeDemo"), setting1); 
				  var plot4 = $.jqplot('chart1', [[14, 32, 41, 44, 40, 37, 29], [7, 12, 15, 17, 20, 27, 39]], {
				      stackSeries: true, 
				       axesDefaults: {
    ...
    // from their vertical bar counterpart.
		     var line1 = [['C/* /* up Holder Pinion Bob', 7], ['Generic Fog Lamp', 9], ['HDTV Receiver', 15], 
...
<div class="mainToolbar">
	<table width="100%" >
		<tr>
			...
			<a id="menuBtn" href="#" onclick="showMenu(); return false;">选择组织</a>&nbsp;<input id="citySel" type="text" readonly value="" style="width:220px;height:20px;" onclick="showMenu();" />
...
<div region="center" border="false" style="border-left:1px solid #efefef;background-color:#ccc" id="layoutCenter" >
  ...
  <div class="process_head_tab_box"> 
 	 <a class="process_head_tab_active"  href="process_desk_index.action"><img src="iwork_img/km/chart.gif">流程实例概览</a>
     <a class="process_head_tab"    href="process_desk_finish.action"><img src="iwork_img/km/chart.gif">办理时长分布</a>
     <a class="process_head_tab"  href="process_desk_notice.action">TOP10</a>
