	...
	function beforeAsync() {
		...
		function sendSigns(){
			...
			for(var i=0;i<arr.length;i++){
 			...
 			var b = userlist.join(",");
			$.post('processRuntimeSigns_send.action',{actDefId:actDefId,prcDefId:prcDefId,actStepDefId:actStepDefId,taskId:taskId,instanceId:instanceId,excutionId:excutionId,userlist:b},function(data){
				if(data=='success'){
					_close();
				}else{
...
<body class="easyui-layout">
    ...
    <div region="south" style="text-align:right;vertical-align:bottom;height:60px;border-top:1px solid #efefef;color:#0000FF;font-size:12px;padding-top:10px;padding-left:10px;" border="false" >
    	<a href="###" onclick="sendSigns()" class="easyui-linkbutton" plain="false" iconCls="icon-ok">完成会签</a>	
