        ...
        <div class="easyui-layout" fit="true">
            ...
            <s:form id="editForm" name="editForm" action="sysProcessDefinition!save.action"  theme="simple"  enctype="multipart/form-data">
            	<table width="100%" border="0" cellpadding="0" cellspacing="0">
            		<tr>
            			<td>流程标题：</td>
            			<td><input class="easyui-validatebox"  type="text" name="model.title" id ="title"  required="true" style="width:190px"></td>
            		</tr>
            		<tr>
            			<td>流程状态：</td>
            			<td> <s:radio name="model.state" list="%{#{'1':'开启','0':'关闭'}}" label="流程状态" listKey="key" key="model.state"/></td>
            		</tr>
            		<tr>
            			<td>模型管理员：</td>
            			<td> <input class="easyui-validatebox" type="text" name="model.master" style="width:190px"></input></td>
            		</tr>
            		<tr>
            			<td>模型描述：</td>
            			<td> <textarea name="model.context" style="height:100px;width:190px;" ></textarea></td>
            		</tr>
            		<tr>
            			<td>上传部署文件：</td>
            			<td> <s:file name="upload"  label="上传的文件" /></td>
            		</tr>
            	</table>
