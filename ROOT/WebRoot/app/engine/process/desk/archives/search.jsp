...
<script>
	function doSearch(){
		...
		if(searchTxt==null){
			...
			$('form').attr('action','process_archives_doSearch.action');
			$("#editForm").submit();
	}
...
<body class="easyui-layout">
	...
	<s:form id="editForm" name="editForm" theme="simple">
				<DIV><table width="100%"><TR><TD><h1>流程归档单据跟踪</h1> </TD><TD> </TD></TR></table></DIV>
				<div style="padding-top:10px;color:#333;padding-left:50px;">
				
				<div >
					<table>
						<tr id="optionSearch">
							<td class="searchTitle">流程经办人</td>
	...
	<div region="center" style="text-align:left;border:0px;padding:10px;">
				<iframe name="resultFrame"  id="resultFrame" iframe scrolling="auto" frameborder="0"  src="process_archives_doSearch.action" style="width:100%;height:100%;"></iframe>
	</div>
