					...
					<table width="100%" style="border:1px solid #efefef" cellpadding='1' cellspacing='0'>
							...
							<s:iterator  value="list" status="status"> 
								...
								<s:property value="description"  escapeHtml="false"/>
									...
									<td><a target="_blank" href="loadProcessFormPage.action?actDefId=<s:property value="processDefinitionId"  escapeHtml="false"/>&instanceId=<s:property value="processInstanceId"  escapeHtml="false"/>&excutionId=<s:property value="executionId"  escapeHtml="false"/>&taskId=<s:property value="id"  escapeHtml="false"/>">表单链接</a></td>
								</tr>
						  	</s:iterator> 
					</table>
		</div>
