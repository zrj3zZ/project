...
<title>IWORK综合应用管理系统</title> 
	...
	<script type="text/javascript" src="iwork_js/engine/dbview_index.js" ></script>	
...
<!-- TOP区 -->
	<div region="north" border="false" style="height:40px;padding:0px;overflow:no;scrolling:no;border-bottom:1px;">
		<div class="tools_nav">
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<a href="javascript:add();" class="easyui-linkbutton" plain="true" iconCls="icon-add">新增视图</a>
					...
					<tr>
						<td class="tree_main">
							<div style="height:430px;width:210px;position:absolute; overflow-y:auto">
								<ul id="dbviewTree" class="ztree"></ul>
							</div>
						</td>
					</tr>
					<tr>
	...
	<div region="center" style="padding:3px;border:0px;">
			<iframe id="metadataListFrame"  frameborder="no" border="0" marginwidth="0″ marginheight="0″ scrolling="auto" allowtransparency="yes"  id="metadataFrame" name="metadataFrame" width="100%" height="100%"></iframe>
