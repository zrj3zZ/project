...
.setup_pic_font{ color:#000; font-family:Arial; font-size:10px; padding-left:35px; padding-top:50px;-webkit-text-size-adjust:none;}		
	...
	<script type="text/javascript">
		...
		function addTriggerItem(){
				var  demId =$("#demId").val();
				var pageUrl = "sysDem_trigger_add.action?demId="+demId;
		...
		function editItem(id){
				var  demId =$("#demId").val();
				var pageUrl = "sysDem_trigger_edit.action?demId="+demId+"&id="+id;
				 art.dialog.open(pageUrl,{
			    	id:'DemTriggerWinDiv',
			    	title:'数据维护触发器设置',
					lock:true,
		...
		function delItem(id){
		    art.dialog.confirm('确定删除？',function(){
	           				$.post('sysDem_trigger_remove.action',{id:id},function(data){
	           				   if(data=="ok"){
	           				      location.reload();
	           				   }
	           				});
				...
				<tr >
					...
					<td width="90%">
							...
							<tr>
								...
								<td class="td_data">
									<s:property value="eventTypeName"/>
								</td>
							</tr>
							<tr>
