 ...
 //==========================装载快捷键===============================//快捷键
      ...
      successFunc=function(responseText, statusText, xhr, $form){
		...
		function loadTableName(){
			...
			var pageurl = 'sysEngineMetadata_tablename_create.action?entitytitle='+encodeURI(entitytitle);
			if(entitytitle!=''){
				$.ajax({ 
			            type:'POST',
			            url:pageurl,
...
<body class="easyui-layout">
  ...
  <div class="tools_nav">
            ...
            <s:form name="editForm" id="editForm" action="sysEngineMetadata!save.action"  theme="simple">
            	<table width="100%"  border="0" cellpadding="5" cellspacing="0">
            		<tr style="display:none">
            			...
            			<td  class="form_data">  
            				<s:if test="model.entityname==null">
            					<s:radio  name="model.entitytype" cssStyle="border:0px;" cssClass="{maxlength:32,required:true}" listKey="key" listValue="value"  list="#{'0':'存储模型','1':'视图模型'}" value="model.entitytype" theme="simple"/>
            				</s:if> 
            				<s:else>
            		...
            		<tr>
            			...
            			<td class="form_data">
            				<s:if test="model.entityname==null">
            					<s:textfield name="model.entityname" theme="simple" cssClass="{maxlength:32,required:true}" />
            				</s:if>
            				<s:else>
            ...
            <div region="south" style="border:0px;padding:10px;height:120px;">
