...
},message:"请输入邮件地址."},url:{validator:function(_2fc){
...
},message:"请输入URL地址."},length:{validator:function(_2fd,_2fe){
var len=$.trim(_2fd).length;
return len>=_2fe[0]&&len<=_2fe[1];
},message:"请输入一个 {0}到{1}之间的值."},remote:{validator:function(_2ff,_300){
var data={};
data[_300[1]]=_2ff;
