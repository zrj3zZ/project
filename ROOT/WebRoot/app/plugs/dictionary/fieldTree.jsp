   ...
   <script type="text/javascript">
		$(function(){
	             var setting = {
					...
					async: {
						enable:true,
						url:"sys_dictionary_design_showFieldJson.action?type=<s:property value='showtype' escapeHtml='false'/>",
						dataType:"json",
						otherParam:{'dictionaryId':'<s:property value='dictionaryId' escapeHtml='false'/>'}
					}, 
					callback: {
						onClick: onClick,
