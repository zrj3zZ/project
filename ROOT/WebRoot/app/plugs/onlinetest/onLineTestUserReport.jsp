...
<link rel="stylesheet" type="text/css" href="iwork_css/common.css">
	...
	<script type="text/javascript">
		...
		function doResize() {
			var ss = getPageSize(); 
			$("#ireport_grid").jqGrid('setGridWidth', ss.WinW-30).jqGrid('setGridHeight', ss.WinH-165); 
		} 
		...
		function exportExcel() {
			...
			var exportUrl = "ireport_rt_formReportExportExcel.action?" + msg;
...
<!-- TOP区 -->
	...
	<!-- <a href="###" onclick="exportExcel()"><img src="../iwork_img/file/excel.gif" border="0">导出Excel</a>   -->
	 <!-- <a href="#"><img src="../iwork_img/file/pdf.jpg" border="0">导出PDF</a>  <a href="#"><img src="../iwork_img/file/word.gif" border="0">导出Word</a> --></div>
			...
			jQuery("#ireport_grid").jqGrid({
		   		url:'onLineTestUserReportDoSearch.action?userId=<s:property  value="userId" escapeHtml="false" />&paperno=<s:property  value="paperno" escapeHtml="false" />',
				datatype: "json",
				mtype: "POST",
				autowidth:true,
				rownumbers:true,
	...
	<s:hidden name = "paperno" id = "paperno" />
	<s:property  value="paperno" escapeHtml="false" />
</body>
</html>
