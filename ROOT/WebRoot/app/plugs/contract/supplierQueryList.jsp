	   ...
	   //  alert(sum);
		$("#pp").pagination({
			    ...
			    onSelectPage:function(pageNumber, pageSize){
			    	var pageUrl="iwork_supplier_query.action?pageSize="+pageSize+"&pageNumber="+pageNumber+"&partyNo="+$("#partyNo").val()+"&pactParty="+$("#pactParty").val()+"&contrctDate="+$("#contrctDate").val()+"&fromDate="+$("#fromDate").val();
