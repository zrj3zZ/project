...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>
		...
		$("#pp").pagination({
			   ...
			   // sum:<s:property value="sum"/>;
			    ...
			    onSelectPage:function(pageNumber, pageSize){
			    	var pageUrl="iwork_query_receivable.action?pageSize="+pageSize+"&pageNumber="+pageNumber+"&eventContract="+<s:property value="eventContract"/>+"&pactNo="+$("#pactNo").val()+"&pactName="+$("#pactName").val()
	...
	function doSearch(){ 
            ...
            // alert(sum);
		     ...
		     window.location.href="iwork_query_receivable.action?pactNo="+pactNo+"&pactName="+pactName+"&sum="+sum+"&eventContract="+eventContract+"&ContractProperties="+ContractProperties+"&contractNature="+contractNature+"&year="+year;   
    }
...
<div class="topCss">
           <fieldset width="100%">
             	...
             	<div class="tableList">
	                <table width="100%">
             		...
             		<tr>
	            		...
	            		<td><s:property value="YSKJE"/></td>
	            		<td><s:property value="WSKJE"/></td>	            		
             		</tr>
             		</s:iterator>           			
             		</table>
             </div>
            ...
            <s:hidden name="sum" value="1"></s:hidden>
            </s:form>
