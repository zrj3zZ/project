            ...
            <legend>查询</legend>    
            		<table width="100%">
            			<tr>
            				...
            				<td>合同类别</td>
            				<td>
                               <s:radio name="sum" id="sum" list="%{#{'1':'收款','2':'付款'}}" theme="simple" value="sum>"></s:radio>
                             </td>           				
            			</tr>
            			<tr>
	                ...
	                <table width="100%">
             		...
             		<s:iterator value="list">            			
             		 <tr>
	            		...
	            		<td><a href="iwork_contract_basecontract.action?instanceId=<s:property value="INSTANCEID"/>&itemno=<s:property value="PACTNO"/>" target="_self"><s:property value="PACTNO"/></a></td>           		
