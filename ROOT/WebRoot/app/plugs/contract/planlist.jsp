...
<title>IWORK综合应用管理系统</title>
	...
	<script>
		...
		pageUrl = "createFormInstance.action?formid="+formId+"&demId="+demId+"&PACTNO="+itemno+"&PACTNAME="+itemname;
		 art.dialog.open(pageUrl,{
			    	id:"planlistDlg",
			    	title:"添加合同计划",  
					lock:true,
           ...
           <fieldset width="100%">
            <legend>信息预览</legend>    
            		<table width="100%">
            			<tr>
            				<td>
            					合同总金额（<s:property value="baseinfo.currencyString"/>）:<s:property value="baseinfo.sumNum"/>
            				</td>
            				<td></td>
            				<td>
	            				<s:property value="baseinfo.planCollectionString"/>（<s:property value="baseinfo.currencyString"/>）:
	            				<s:property value="baseinfo.planNum"/>
            				</td>
            				<td> </td>
            				<td>
            					<s:property value="baseinfo.invoicePlanCollectionString"/>（<s:property value="baseinfo.currencyString"/>）:<s:property value="baseinfo.ticketPlanNum"/>
            				</td>
            				<td></td>
            			</tr>
            			<tr>
            				...
            				<td></td>
            				<td>
	            				<s:property value="baseinfo.actualCollectionString"/>（<s:property value="baseinfo.currencyString"/>）:<s:property value="baseinfo.realNum"/>
            				</td>
            				<td></td>
            				<td>
            					<s:property value="baseinfo.invoicePerformCollectionString"/>（<s:property value="baseinfo.currencyString"/>）:<s:property value="baseinfo.ticketNum"/>
            				</td>
            				<td></td>
            			</tr>
            			<tr>
             ...
             <div class="listCss">
             	<div class="tools_nav" >
             		...
             		<div class="addItemBtn" onclick="javascript:addPlan();" style="float:left;width:120px;height:10px;"><span>添加计划</span> </div>          	
             		<div class="addDeleBtn" onclick="javascript:delcfm();" style="float:left;width:120px;height:10px;"><span>删除</span></div>
