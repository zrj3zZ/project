	...
	$(function(){
		$("#pp").pagination({
			...
			onSelectPage:function(pageNumber, pageSize){
				var pageUrl="iwork_fi_self_account.action?pageSize="+pageSize+"&pageNumber="+pageNumber;
					window.location.href = pageUrl;
				}
			});
		});
		function addItem(){ 
			var pageUrl="processRuntimeStartInstance.action?actDefId=FYBXLC:1:71604";
			window.open(pageUrl);
		}
		function doQuery(){
			var travel1 = $('#travel1').val();
			var travel2 = $('#travel2').val();
			window.location.href = "iwork_fi_self_account.action?travel1=" + travel1 + "&travel2=" + travel2;
		}
	</script>
</head>
		 ...
		 <div class="tools_nav">
		 	...
		 	<div style="padding:0px;border:1px solid #ccc;background:#FFFFEE;">
				<table width='90%' border='0' cellpadding='0' cellspacing='0'> 
					<tr> 
						 ...
						 <s:form name="mainFrm" id="mainFrm" action="iwork_fi_self_account"> 
            ...
            <div region="center" border="false" style="background: #fff;border:1px solid #fff">
            	<table width="100%" cellspacing="0" cellpadding="0" border="0">
            		<tr>
		 				<td class="title" style="width:35px;">序号</td>
		 				<td class="title" style="width:120px;" >单据编号</td>
		 				<td class="title" style="width:120px;" >申请人</td>
		 				<td class="title" style="width:120px;" >申请日期</td>
		 				<td class="title" style="width:120px;">费用类别</td>
		 				<td class="title" style="width:120px;">结算方式</td>
		 				<td class="title" style="width:120px;">附单张数</td>
		 				<td class="title"  style="width:120px;" >申请报销金额</td>
		 				<td class="title"  style="width:120px;" >实际报销金额</td>
		 				<td class="title"  style="width:120px;" >借款余额</td>
		 				<td class="title"  style="width:120px;" >本次冲销金额</td>
		 				<td class="title"  style="width:120px;" >实际支付金额</td>
		 			</tr>
