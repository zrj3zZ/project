...
<html>
  <head>
	...
	$(document).ready(function() { 
		var parentColId = "attachments";
		var parentFileDivId = "mailAttachDiv";
		var  sizeLimit = 102400000;
		var  multi = 'true';
		var  fileExt = null;
		var  fileDesc=null;
	  ...
	  $('#uploadify').uploadify({
	    ...
	    'onAllComplete':function(event,data) {
	  					  try{
								...
								//如果标题为空，则设置标题为上传的第一个附件
								var mailTitle = origin.document.getElementById("_title").value;
								if(mailTitle==''){
									origin.document.getElementById("_title").value = firstFileTitle;
								}
								//关闭当前窗口
								closeWin();
							}catch(e){}
