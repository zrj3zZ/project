...
<script type="text/javascript" src="iwork_js/bindclick.js"  ></script>
	...
	$(function() {
		...
		function EditAppiont(){
			...
			var fs=$("#FS").val();
			if(fs>10){
				alert("总分10分，您填写的分数过高！");
				return ;
			}
			kflb = encodeURI(kflb);
			var CJZH =$("#CJZH").val() ;	
			var pageurl = "updatekflb.action?KFLB="+kflb+"&CJZH="+CJZH+"&kflbid="+kflbid+"&FS="+fs;	
						...
						<s:iterator value="runList"  status="status">
							...
							<tr id="itemTr_0">
								...
								<td class="td_data" id="data_kflb" width="35%">
									<input type='text' class = '{maxlength:128,required:true,string:true}'  style="width:300px;" name='KFLB' id='KFLB'  value='<s:property value="KFLB" />'form-type='al_textbox'><font style="color:red;padding-left:5px">*</font>　&nbsp;　
								</td>
							</tr>
							<tr id="itemTr_1">
								<s:hidden name="ID" id="ID"></s:hidden>
								...
								<td class="td_data" id="data_kflb" width="35%">
									<input type='text' class = '{maxlength:128,required:true,string:true}'  style="width:300px;" name='FS' id='FS'  value='<s:property value="FS" />'form-type='al_textbox'><font style="color:red;padding-left:5px">*</font>　&nbsp;　
								</td>
							</tr>
							<tr id="itemTr_18">
								...
								<td class="td_data" id="data_CJZH" width="35%">
									<input type='text' class = '{maxlength:128,required:true,string:true}' readonly="true"  style="width:300px"  name='CJZH' id='CJZH'  value='<s:property value="CJZH" />' >&nbsp;
								</td>
							</tr>
							<tr id="itemTr_2">
