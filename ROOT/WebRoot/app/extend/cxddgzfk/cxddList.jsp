...
<script type="text/javascript">
	...
	function showVote(ggid){
		var pageUrl = "zqb_cxdd_goList.action?ggid="+ggid;
		...
		<div style="padding:5px">
			<table id='iform_grid' width="100%" style="border:1px solid #efefef">
				<tr class="header">
					...
					<td style="width:20%;">发送人</td>
					<td style="width:20%;">发送时间</td>
				</tr>
				<s:iterator value="list" status="status">
					<tr class="cell">
						<td><a href="javascript:showVote('<s:property value='ID'/>')"><s:property value="TZBT" /></a></td>
			...
			<form action="zqb_cxdd_index.action" method=post name=frmMain id=frmMain>
