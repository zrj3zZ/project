...
_plugin('core', function(K) {
	...
	self.beforeGetHtml(function(html) {
		...
		.replace(/<img[^>]*class="formObj"?[^>]*>/ig, function(full) {
			var imgAttrs = _getAttrList(full);
	...
	self.beforeSetHtml(function(html) {
		...
		.replace(/\$\{[a-zA-Z_]*\}?/ig, function(full) {
			return '<img class="formObj" src="' + self.themesPath + 'common/formObj.png"  data-ke-name="' + full + '" />';
		})
