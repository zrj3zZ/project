    ...
    <div id="header">
                  <div class="qg-logo"><a href="mainAction.action"><img src="iwork_layout/skins2014/image/logo1.png"></a></div>
                    ...
                    <div class="qg-topmenu qg-topmenu-space" model-node="drop_menu_list">
                        <dl class="my-ch">
                            <dd class="current">
                                <i class="qg-ico18 ico-choosed"
                                    event-node='default_space' event-args='space_name=itd&current_default=itd'></i>
                                    <a href="https://itd.qimingdao.com/core/Index/index">BPM</a> 
                                    <div class="qg-tips" style="display:none">
                                        <div class="tips-up"><span><em>◆</em></span></div>
                                        <div class="tips-btm">默认空间</div>
                                    </div>
                            </dd>                                                        <dd class="q-func"><a href="http://www.qimingdao.com/www/Register/createNew" >添加模块到“更多”</a></dd>
                                                    </dl>
                    </div>
            </div>        <!-- 已登录 --> 
        <!-- 头部导航END  -->
        <div class="qg-person">
            <ul>
                <li class="dorp-right"><a href="mainAction.action" class="q-tab">我的首页<i class="ico-arrow-down"></i></a>
                    ...
                    <div class="qg-topmenu qg-topmenu-msg" model-node="drop_menu_list">
                        <dl>
                            <dd><a href="https://itd.qimingdao.com/core/Message/message">
                                <label id='unread_message'>
                                                                </label>
                                私信                            </a></dd>

                            <dd><a href="https://itd.qimingdao.com/core/Mhttp://127.0.0.1:8080/mainAction.action##essage/notify">
                ...
                <li class="dorp-right"><a href="javascript:;" class="q-tab"><i class="aicon-set"></i></a>
                    <div class="qg-topmenu qg-topmenu-set" model-node="drop_menu_list">
                        <dl>
                            <dd><a href="syspersion_info.action">个人设置</a></dd>
                                                        <dd>
                            </dd>                            <dd><a href="https://itd.qimingdao.com/core/Manage/index">空间管理</a></dd>                            <dd class="qg-lan">
                        ...
                        <div class="q-func"><a href="https://itd.qimingdao.com/core/Login/logout">退出</a></div>
                    </div>
                </li>
            </ul>
           </div>
            <form method='GET' action="https://itd.qimingdao.com/core/Search/index"  class="qg-search">
            ...
            <div class="qg-nav">
                <ul>
                                <li class="current">
                    <a href="mainAction.action" class="q-nav"><span>首页</span></a></li>                <li >
                    <a href="process_desk_index.action" class="q-nav"><span>流程中心</span></a></li>                <li >
                    <a href="https://itd.qimingdao.com/contact/Index/index" class="q-nav"><span>报表中心</span></a></li>                <li >
                    <a href="https://itd.qimingdao.com/project/Index/index" class="q-nav"><span>知识库</span></a></li>                <li >
                    <a href="https://itd.qimingdao.com/project/Index/index" class="q-nav"><span>问答</span></a></li>                <li >
...
<div id="page-wrap">
        <div class="qq-fixed">
            <a href="http://wpa.qq.com/msgrd?v=3&uin=412619081&site=qq&menu=yes" class="qg-ico18 ico-qq" target="_blank"></a>
        </div>
...
<a href="" class="face"><img src="iwork_img/big.jpg" width="144" /></a>
<a href="" class="name"><span>杨大永</span></a>
...
<!--  选中判断 -->
<ul class="basic-list">
	<li class="current" ><a href="https://itd.qimingdao.com/core/Index/index" class="lev"><i class="aicon-home"></i>首页</a></li>
    <li  ><a href="https://itd.qimingdao.com/core/Message/index" class="lev"><i class="aicon-email"></i>消息</a></li>
	<li  style="display:none">
		<a href="https://itd.qimingdao.com/core/Mention/index" class="lev2"><i class="aicon-at"></i>提到我的</a></li>
	<li  style="display:none">
		<a href="https://itd.qimingdao.com/core/Comment/index" class="lev2"><i class="aicon-weibo"></i>我的评论</a></li>
    <li  style="display:none">
    	<a href="https://itd.qimingdao.com/core/Message/index" class="lev2" ><i class="aicon-message"></i>我的消息</a></li>
...
<ul class="app-list">
<li  >
    <a href="https://itd.qimingdao.com/task/Index/index" class="lev" id='leftApp3' event-node="fast_left" event-args='app_name=task&fast=0'>
    <div class="icon-pic icon-app-task"><img src="https://static.qimingdao.com/apps/task/appinfo/icon_app.png" width='24'>任务</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/ioffice/Index/index" class="lev" id='leftApp14' event-node="fast_left" event-args='app_name=ioffice&fast=0'>
    <div class="icon-pic icon-app-ioffice"><img src="https://static.qimingdao.com/apps/ioffice/appinfo/icon_app.png" width='24'>办公助理</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/calendar/Index/index" class="lev" id='leftApp19' event-node="fast_left" event-args='app_name=calendar&fast=0'>
    <div class="icon-pic icon-app-calendar"><img src="https://static.qimingdao.com/apps/calendar/appinfo/icon_app.png" width='24'>日历</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/file/Index/index" class="lev" id='leftApp12' event-node="fast_left" event-args='app_name=file&fast=0'>
    <div class="icon-pic icon-app-file"><img src="https://static.qimingdao.com/apps/file/appinfo/icon_app.png" width='24'>文件</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/crm/Index/index" class="lev" id='leftApp9' event-node="fast_left" event-args='app_name=crm&fast=0'>
    <div class="icon-pic icon-app-crm"><img src="https://static.qimingdao.com/apps/crm/appinfo/icon_app.png" width='24'>CRM</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/meeting/Index/index" class="lev" id='leftApp7' event-node="fast_left" event-args='app_name=meeting&fast=1'>
    <div class="icon-pic icon-app-meeting"><img src="https://static.qimingdao.com/apps/meeting/appinfo/icon_app.png" width='24'>会议</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/sina/Index/index" class="lev" id='leftApp2' event-node="fast_left" event-args='app_name=sina&fast=0'>
    <div class="icon-pic icon-app-sina"><img src="https://static.qimingdao.com/apps/sina/appinfo/icon_app.png" width='24'>新浪微博</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/blog/Index/index" class="lev" id='leftApp1' event-node="fast_left" event-args='app_name=blog&fast=0'>
    <div class="icon-pic icon-app-blog"><img src="https://static.qimingdao.com/apps/blog/appinfo/icon_app.png" width='24'>博客</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/wiki/Index/index" class="lev" id='leftApp8' event-node="fast_left" event-args='app_name=wiki&fast=0'>
    <div class="icon-pic icon-app-wiki"><img src="https://static.qimingdao.com/apps/wiki/appinfo/icon_app.png" width='24'>Wiki</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/project/Index/index" class="lev" id='leftApp5' event-node="fast_left" event-args='app_name=project&fast=1'>
    <div class="icon-pic icon-app-project"><img src="https://static.qimingdao.com/apps/project/appinfo/icon_app.png" width='24'>项目</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/contact/Index/index" class="lev" id='leftApp4' event-node="fast_left" event-args='app_name=contact&fast=0'>
    <div class="icon-pic icon-app-contact"><img src="https://static.qimingdao.com/apps/contact/appinfo/icon_app.png" width='24'>通讯录</div>
    </a>
</li><li  >
    <a href="https://itd.qimingdao.com/spark/Index/index" class="lev" id='leftApp15' event-node="fast_left" event-args='app_name=spark&fast=0'>
    <div class="icon-pic icon-app-spark"><img src="https://static.qimingdao.com/apps/spark/appinfo/icon_app.png" width='24'>问答</div>
    </a>
</li><li ><a href="https://itd.qimingdao.com/core/App/index" class="lev"><i class="icon-pic ico-appadd"></i>添加</a></li>
</ul>
</div>
...
<script type="text/javascript">
$(function(){
    if( $('.left-wrap').height() + 200  < $('body').height() ){
	    $(window).bind('scroll resize', function(e){
			var stop = getScrollTop();
			if(stop > 270){
				if(!$('.mod-app').hasClass('app-fixed')){
					$('.mod-app').addClass('app-fixed');
				}
			}else{
				if($('.mod-app').hasClass('app-fixed')){
					$('.mod-app').removeClass('app-fixed');
				}
			}
	    });
	}
    ...
    <div class="ui-state-disabled m-weight border" model-node='widget_box' model-args = 'widget_user_id=1&widget_name=Countdown&widget_desc=PUBLIC_COUNTDOWN&app_name=core&diyId=1'>
...
var addCountdown = function(){
    ui.box.load(U('widget/Countdown/doAdd',{ is_widget:'core' },0),L('PUBLIC_SET_COUNTDOWN'));
}
</script>    <div class="ui-state-disabled mod-person-num border" model-node='widget_box' model-args = 'widget_user_id=1&widget_name=UserCount&widget_desc=PUBLIC_SHOW_COUNT&app_name=core&diyId=1'>
	<a href="https://itd.qimingdao.com/core/Profile/following?uid=3523">
		<h4 node-event>关注</h4>
		<strong event-node ="following_count" event-args ="uid=3523">0</strong>
	</a>
	...
	<a href="https://itd.qimingdao.com/core/Profile/index?uid=3523">
		<h4>微博</h4><strong event-node ="feed_count" event-args ="uid=3523">2</strong>
	</a>
...
<div class="ui-state-disabled m-weight border" model-node='widget_box' model-args = 'widget_user_id=1&widget_name=Invite&widget_desc=PUBLIC_INVITE_COLLEAGUE&app_name=core&diyId=1'>
    <div class="setup hover">
    <a event-node="invite_box" href="javascript:;"  class="qg-ico18 ico-mor"></a>
    <a href="javascript:void(0)" class="ico-circle-arrow-down" event-node='widget_toggle'></a>
    <a href="javascript:void(0)" class="ico-close" event-node='widget_close'></a>
    </div>
    <div class="hd"><h3>邀请同事</h3></div>
    <div model-node="widget_child" class="m-w-invite" >
    <div class="invite">
    <input type="text" name="email[]" class="q-txt left" placeholder="请输入邮件地址..." event-node='invate_email'><a class="btn btn-blue left" href="javascript:;" event-node='send_invite_email'>
            <span>邀请</span></a>
    </div>
    </div>
</div>    <div class="ui-state-disabled m-weight border" model-node='widget_box' model-args = 'widget_user_id=1&widget_name=Weather&widget_desc=PUBLIC_WEATHER_SHOW&app_name=core&diyId=1' >
...
</div>    <div class="ui-state-disabled m-weight border"  model-node='widget_box' model-args = 'widget_user_id=1&widget_name=RecommendUser&widget_desc=PUBLIC_RECOMMEND_FOLLOW&app_name=core&diyId=1'>
<div class="setup hover">
    ...
    <div class="hd"><h3>推荐关注</h3><span><a class="change" href="javascript:;" event-node='hot_change'>换一换</a></span></div>
    </div>
    ...
    <div class="punch-info">
        <ul>
            ...
            <li class="punchon left"><span class="li-left">上班：</span>
                <span id='start_work'  >
                                                <a href="javascript:;" event-node="add_start_punch" class="btn btn-green add_punch"><span>签到</span></a>
                                </span>
                    ...
                    <div class="border boxShadow extend-foot minh">
                        <div class="qg-poster div-focus">
                               ...
                               <div class="qg-poster-tab">
                                    <div id='diffcss'>
                                        <ul>
                                            <li class="current" rel="kind-blog"><span><i class="aicon-bubbles"></i><a href="javascript:;">记事本</a></span></li>
                                                                                        <li rel="kind-task"><span><i class="aicon-task"></i><a href="javascript:;">记任务</a></span></li>
                                                                                        <li rel="kind-blog"><span><i class="aicon-blog-post"></i><a href="javascript:;">写博客</a></span></li>
                                                                                        <li rel="kind-file"><span><i class="aicon-file"></i><a href="javascript:;">传文件</a></span></li>
                                        </ul>
                                    </div>
                                </div>
                                <!--发布微博-->
...
<div class="pwb-bd" model-node="send_feed" model-args='post_event=post_feed'>
    <div class="input">
        ...
        <div class="poster-addons">
            <div class="kind">
                <a class="btn btn-gray right" href="javascript:;" title="按Ctrl+Enter可以快速提交 "><span>发布</span></a>
                <div class="mod-sync">
    <label class="sync-sina" >
        <span class="qg-ico18 ico-sync-sina weiboSync " rel='sina' isbind='0' onclick='loginSelectSync(this);return false;'> </span>
    </label><label class="sync-qq" >
        <span class="qg-ico18 ico-sync-qq weiboSync " rel='qq' isbind='0' onclick='loginSelectSync(this);return false;'> </span>
    </label></div>
<script>
    //同步设置
    function loginSelectSync(obj) {
        var to_status;
        if($(obj).attr('isbind') == "0" ) {
            to_status = 1;
        }else{
            to_status = 0;
        }

        $.post(U('widget/WeiboSync/setWeiboSyncStatus','',0),{ to_status:to_status, type: $(obj).attr('rel') },function(res){
            if( res.status=='NONE' ){
                $(obj).attr('isbind',0);
                ui.box.show(res.data, L('PUBLIC_BIND_ACOUNT'));
                $(obj).removeClass('isbind');
            }else if( res.status=='OUTTIME' ){
                $(obj).attr('isbind',0);
                ui.box.show(res.data, L('PUBLIC_BIND_ACOUNT'));
                $(obj).removeClass('isbind');
                //变灰色样式
    ...
    setTimeout(function(){
        $.post(U('widget/WeiboSync/checkWeiboExpiresTime'),{ },function(res){
            if( res.status!=1 ){
                ui.box.show(res.data, L('PUBLIC_BIND_ACOUNT'));
            }
        },'json');
    ...
    function cancleWeiboAccountBind(obj,type) {
        $.post(U('core/Account/cancleWeiboAccountBind'),{ type:type },function(res){
            if( res.status ){
                ui.success(res.info)
                ui.box.close();
            }else{
...
<script type="text/javascript">
    var exist_value = '';
    var remmber_content = function(){
        var content = $('.textinput').eq(0).val();

        if( content != exist_value ){
            $.post(U('widget/Feed/saveUnpublished'),{ content:content,is_widget:'core' },function(){
                exist_value = content;
            });
    ...
    $(function(){
        ...
        if(exist_value != '' ){
            $('.textinput').eq(0).val('');
            $('.textinput').eq(0).insertAtCaret(exist_value);
        }

        //4分钟保存一次微博内容      
        setInterval('remmber_content()',4000);
 ...
 'itask_title':{
        load:function(){
            ...
            $(obj).keyup(function(e){
                ...
                if( e.keyCode == 13 && bindEnter == true ){
                    obj.parentModel.childEvents['add_itask_title'][0].click();
                }
            });
        }
    },
    'add_itask_title':{
        click:function(){
            var args  = M.getEventArgs(this);
            var title = $('#itask_title').val();
            if( getLength(title) < 1 ){
                ui.error(L('ITASK_ENTER_TITLE'));
                return false;
            }
            var joiner_uid = $('input[name="joiner_uid"]').val();
            var deadline   = $('input[name="deadline"]').val();
            var content    = $('#contents').val();
            $.post(U('task/Do/doAdd'),{ title:title,joiner_uid:joiner_uid,deadline:deadline,content:content },function(msg){
                if(msg.status == 1){
                    ui.success(msg.info);
                    $('#itask_title').val('');
                    ...
                    $('.qg-userlist .user-list li').remove();
                    $('.qg-userlist').find('input').show();
                    $('#search_uids_task').val('');
...
<script type="text/javascript">
$('.ke-empty-record').mouseenter(function(){
    $('.qg-tips').show()
}).mouseleave(function(){
    $('.qg-tips').hide();
});

var Editor_blog_content = {
    editor_query_url : "app=core&mod=Index&act=index&",
    editor_name : "blog_content",
    editor_old_content:'',
    editor_tip: $("#editor_save_info_blog_content"),
    client : { },
    editor_mod:'add',
    has_saved:false
};
...
editor.save   = function(){
    ...
    if( content != editor.editor_old_content){
        editor.editor_tip.html(L('PUBLIC_SAVING'));
        $.post(U('widget/Editor/save'), { '_url':editor.editor_query_url, '_name':editor.editor_name, 'content':content },function(){
...
editor.html = function( html ){
    return editor.client.html( html );
};
...
core.loadFile('https://static.qimingdao.com/apps/core/static/js/editor/kindeditor-4.1.1/kindeditor.js?v='+VERSION,function(){
    editor.client = KindEditor.create('textarea[name="blog_content"]', {
        langType : 'zh-cn',
        uploadJson: 'https://itd.qimingdao.com/widget/Attach/saveEditorImg',
        cssPath : 'https://static.qimingdao.com/apps/core/static/js/editor/kindeditor-4.1.1/plugins/code/prettify.css?v='+VERSION,
        items : [
                                'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'strikethrough',
                                'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent',
                                'link', 'unlink','clearhtml',
                                'fullscreen'
                                 ],
        editor_name : 'blog_content',
        afterCreate: function(obj){
            var cssLink  = obj.edit.doc.createElement("link");
            cssLink.href = "https://static.qimingdao.com/apps/core/static/js/editor/editorCustom.css?v="+VERSION;
            cssLink.rel  = "stylesheet";
            cssLink.type = "text/css";
            obj.edit.doc.getElementsByTagName('head')[0].appendChild(cssLink);
            editor.save_interval = setInterval(editor.save,10000);
            $('.ke-outline:last').addClass('ke-zoom');
            setAutoTipsEditor(obj,contentId);
            editor.editor_old_content = obj.html();
            if(editor.editor_mod == 'edit'){
                $(window).bind("beforeunload",function(e){
                     if( editor.has_saved == false ){
                        return LANG.LEAVE_PAGE_TIPS;
                     }
                });
            }
        }
    });
    if("undefined" != typeof(prettyPrint)){
        prettyPrint();
    }
});

})(Editor_blog_content,'blog_content');
</script></dd>
...
<script type="text/javascript" src="https://static.qimingdao.com/apps/core/static/js/module.form.js?v="></script>
<script type="text/javascript" src="https://static.qimingdao.com/apps/blog/static/js/blog.js?v="> </script>
<script type="text/javascript">
    $("#drop_select_category_id").click(
        function(){
            $(this).children("ul").toggle();
        }
    );
    $("#drop_select_category_id ul li").click(
        function(){
            if( $(this.children[0]).attr('va') ==0 ){
                blog.addUserCategory(1);
            }

            var c_ul = $(this).parent();
            c_ul.prev("a").html($(this).text()+'<i class="ico-arrow-down right"></i>');
            $("#categoryId").val($(this.children[0]).attr('va'));
            c_ul.hide('quick');
        }
    );
</script>
...
M.addModelFns({
    ...
    'addBlogForm':{
        callback:function(msg) {
            this.ajaxSubmitIng = 1;
            ui.success( msg.info );
            Editor_blog_content.cleanEditorCache();
            setTimeout(function(){
                location.reload();
            },1500);
        }
    ...
    'submit_blog':{
        click:function(){
            core.toggleSubmitCSS(this, 'btn-green','' );

            this.parentModel.blog_content.value = Editor_blog_content.html();
                ...
                <div class="acts">
                    ...
                    <div class="tab-menu tab-animate">
                        <div class="feed-group">
                         ...
                         <ul>
                            <li class="current" model-node ="myfollow"><span><a href="javascript:void(0);" >我关注的<i class="ico-arrow-down"></i></a></span></li>
                                                        <li  ><span><a href="https://itd.qimingdao.com/core/Index/index?type=all">全站动态</a></span></li>
                                                        <li  ><span><a href="https://itd.qimingdao.com/core/Index/index?type=sina">新浪微博</a></span></li>                                                    </ul>
                        <div class="tab-animate-block"></div>
                    </div>
                    <div class="mod-feed-tab" id="mod-feed-tab" >
                        <ul class="inner-feed-nav">
                            <li class="current" rel=''>
<a href="javascript:;" onclick="core.weibo.ajaxFeedPage(this)">全部</a></li>
<li rel='post'>
<a  href="javascript:;" onclick="core.weibo.ajaxFeedPage(this)" >原创</a>
</li>
<li rel='repost'>
<a  href="javascript:;" onclick="core.weibo.ajaxFeedPage(this)" >转发</a>
</li>

<li rel='postimage'>
<a href="javascript:;" onclick="core.weibo.ajaxFeedPage(this)">图片</a></li>

<li rel="postfile">
<a href="javascript:;" onclick="core.weibo.ajaxFeedPage(this)">附件</a></li>

<li rel="postvideo">
<a href="javascript:;" onclick="core.weibo.ajaxFeedPage(this)">视频</a></li>
                                                    </ul>
                    </div>
                    </div>
                    <!--feed list-->
...
<script type="text/javascript" src="https://static.qimingdao.com/apps/core/static/js/plugins/core.weibo.js?v="></script>
...
<script>
var feed_args = new Array();
feed_args['topic_id']    = '';  //话题ID
feed_args['initNums']    = '140';  //feed nums
feed_args['maxId']       = '0';   // firstid
feed_args['loadId']      = '0';    // lastid
feed_args['feedType']    = 'following';      //关注的，全站的
feed_args['fgid']        = '0';      //followgid
feed_args['loadmore']    = '1';  //if load more
feed_args['loadnew']     = '1';   //if load new
feed_args['uid']         = '3523';  //某人的微博
feed_args['feed_type']   = '';      //全部、原创、图片、附件
feed_args['ext_id']      = '';         //扩展的ID
feed_args['app_name']    = 'core';
feed_args['model_name']  = 'feed';
feed_args['key']  = '';
feed_args['canshare']  = '1';
core.weibo.init(feed_args);
</script>
<label>
<dl style="display:none;" id="show_action" class="dropdown-menu drop_clayer" >
    <span id='app_name' style='display: none'>core</span>
    <span id='model_name' style='display: none'>feed</span>
    <dd>
        <ul>
            <li><a href="javascript:;" onClick='core.weibo.turn_to_task(this)'>转为任务</a></li>
                        <li><a href="javascript:;" onClick='core.weibo.set_feed_notice(this)'>设为公告</a></li>                    </ul>
    </dd>
</dl>
</label>                                        </div>
                    </div>
...
<div class="inner">
<ul>
    <li><a href="https://itd.qimingdao.com/core/Index/index">我关注的</a></li>
        <li class="line"></li>
    <li><a href="javascript:void(0)" event-node="editFollowgroup"><i class="aicon-setup"></i>管理分组</a></li>
</ul>
</div>
</div>
<script type="text/javascript">
$(window).bind('scroll resize',function(){
    if($('.boxy-modal-blackout').length > 0 ){
        $('.boxy-modal-blackout').css('height',$('body').height());
    }
});
</script>
<!--=> ft <=-->
<div id="footer">
    <div class="client">
        <ul>
            <li><a href="http://www.qimingdao.com/www/Index/mobile#android"><i class="aicon-android"></i>Android</a></li>
            <li><a href="http://www.qimingdao.com/www/Index/mobile#iphone"><i class="aicon-ios"></i>iPhone</a></li>
            <li><a href="http://weibo.com/qimingdao" target="_blank"><i class="aicon-sina"></i>新浪微博</a></li>
<!--             <li><a href="http://t.qq.com/qiming-dao" target="_blank"><i class="icon-tencent"></i>腾讯微博</a></li>
 -->        </ul>
    </div>
    <div class="copyright">
        <p>Copyright(C) 2014 <a href="http://www.qimingcx.com" target="_blank">企明创想科技（北京）有限公司</a>  京ICP备12043244号  京公网安备11010802011485号</p>
    </div>
</div>
<!--=> ft End <=-->

<script type="text/javascript" src="https://www.qimingdao.com/online.php?sp=itd&a=core&m=Index&c=index&t=ce0bb013dd0fd94c&tx=1398310697&act=trace&u=3523&n=杨大永&ref=https://itd.qimingdao.com/core/Index/index?type=sina"></script>
<script type="text/javascript">
//打卡弹窗的展示
$.post(U('widget/IofficePunch/render'),{ tpl:'pop',is_widget:'ioffice',ajax:1 },function(msg){
    if(msg.status == 1){
