...
public class GetWorkDayTimeMillisecond {
	 ...
	 * @param args
	 */
	private static Logger logger = Logger.getLogger(GetWorkDayTimeMillisecond.class);
	public static void main(String[] args) {
		// TODO Auto­generated method stub
		GetWorkDayTimeMillisecond a = new GetWorkDayTimeMillisecond();
		Long b = a.getWorkdayTimeInMillis("2010­05­17 8­00­00",
	...
	public Long getWorkdayTimeInMillis(long start, long end){
		...
		if(sdate.get(Calendar.YEAR)==edate.get(Calendar.YEAR)&&sdate.get(Calendar.WEEK_OF_YEAR)==edate.get(Calendar.WEEK_OF_YEAR)&& sdate.get(Calendar.DAY_OF_WEEK)!=1 &&sdate.get(Calendar.DAY_OF_WEEK)!=7&& edate.get(Calendar.DAY_OF_WEEK)!=1 &&edate.get(Calendar.DAY_OF_WEEK)!=7){
	...
	public int getDaysBetween(Calendar start, Calendar end){
		...
		if (start.get(Calendar.YEAR) != y2) {start = (Calendar) start.clone();
		do {
