...
public class LunarUtil {
    ...
    private static Logger logger = Logger.getLogger(LunarUtil.class);
    public static String getLunar(Calendar cal){
        ...
        try {
            ...
            logger.error(e,e); //To   change   body   of   catch   statement   use   Options   |   File   Templates.   
        }
    ...
    public static void main(String[] args) throws ParseException {
        ...
        today.setTime(chineseDateFormat.parse("2009.11.15"));
    }
}
