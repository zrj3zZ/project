...
<body class="easyui-layout">
		 	...
		 	<div class="topHead">
		 		<table width="100%" cellspacing="0" cellpadding="0" border="0">
		 			<tr>
		 				...
		 				<td>
		 				<div class="maintitle"><s:property value="systemTitle"/><span style="font-size:30px;color:#fff">审计管理员</span>控制台</div>
		 				</td>
		 				<td></td>
		 ...
		 <div region="west"  class="leftDiv" border="false" style="border-right:1px solid #fff;background-color:#efefef;width:200px;padding-top:10px;">
		 		...
		 		<!--<li class="current" id="auditBoard">审计面板</li> -->
		 			<li id="sys_login_log">系统管理员登录日志</li>
		 			<li id="sys_oparate_log">系统管理员操作日志</li>
		 			<li id="security_login_log">安全管理员登录日志</li>
		 			<li id="security_operator_log">安全管理员授权操作日志</li>
