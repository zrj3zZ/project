	...
	<script type="text/javascript">
		...
		function initTree(){
			var setting = {
						...
						async: {
							enable: true,  
							url:"admin_portlet_design_treeJSON.action", 
							dataType:"json"
						},
						callback: {
							onClick:onClick
	...
	//设置权限
		...
		//===装载数据
			var zTree = $.fn.zTree.getZTreeObj("multitree");
 			...
 			//===请求服务器==
			$.post('admin_portlet_design_setPortlet.action',$("#editForm").serialize(),function(data){
		    	if(data=='success'){
		    		alert("设置成功");
		    		api.close();
		    	}else{ 
...
<body class="easyui-layout">
	<div region="north" style="border-bottom:1px solid #efefef" border="false" >
		<div class="tools_nav">
			<a href="#" onclick="seportlet()" class="easyui-linkbutton" plain="true" iconCls="icon-add">发布到我的面板</a>	
