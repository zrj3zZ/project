		...
		{ 
			...
			function tabCloseEven(){
				...
				function clockon() {
				    ...
				    if (sec < 10) sec = "0" + sec;
				    var arr_week = new Array($lang["星期日"], $lang["星期一"], $lang["星期二"], $lang["星期三"], $lang["星期四"], $lang["星期五"], $lang["星期六"]);
				    week = arr_week[day];
				    var time = ""; 
				    time = year + $lang["年"] + month + $lang["月"] + date + $lang["日"] + " " + hour + ":" + minu + ":" + sec + " " + week;
				    $("#bgclock").html(time);
