	...
	<script type="text/javascript"> 
	  <s:property value="initWeiXinScript" escapeHtml="false"/>
	 	function editSubForm(id){
	 		var pageUrl = 'wechat_pr_subform_edit.action?taskId='+$("#taskId").val()+'&instanceId='+$("#instanceId").val()+'&formId='+$("#formId").val()+'&subformid='+$("#subformid").val()+'&id='+id;
	 	...
	 	function delSubForm(id){
	 		...
	 		var url = "wechat_pr_subform_remove.action"; 
	 	...
	 	function addSubForm(){ 
	 		var pageUrl = 'wechat_pr_subform_add.action?taskId='+$("#taskId").val()+'&instanceId='+$("#instanceId").val()+'&formId='+$("#formId").val()+'&subformid='+$("#subformid").val();
	 		this.showSendWindow(pageUrl); 
	 	}  
	 	function back(){ 
	 		...
	 		var  taskId = $("#taskId").val(); 
	 				window.location ="wechat_pr_formpage.action?actDefId="+actDefId+"&actStepDefId="+actStepDefId+"&instanceId="+instanceId+"&excutionId="+excutionId+"&taskId="+taskId;
	 	}
	 	
	 	//打开数据字典
		function openDictionary(uuid){
			var pageUrl = "wechat_dic_show.action?dictionaryUUID="+uuid;
		...
		function openSubGridDictionary(id,subformkey,subformid){
			var instanceid = $("#instanceId").val(); 
			var pageUrl = "wechat_dic_show.action?dictionaryId="+id+"&subformkey="+subformkey+"&instanceId="+instanceid+"&subformid="+subformid;
			this.showSendWindow(pageUrl); 
		}
	</script>
	<style> 
