...
<title>错误日志</title>
    ...
    <script type="text/javascript" src="iwork_js/system/sys_error_log.js"  > </script>
	<link href="iwork_css/system/sys_error_log.css" rel="stylesheet" type="text/css" />
...
<div region="center" style="padding:10px;border:0px;">
				 ...
				 <td style='padding-top:10px;padding-bottom:10px;'> 
					<table width='100%' border='0' cellpadding='0' cellspacing='0'> 
						<tr> 
							...
							<td class= "searchdata">
							<input id="start" name="start" class="Wdate" type="text"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'{%y-20}-%M-%d %H:%m:%s'})" theme="simple" value='<s:property value="operateDateStart"  escapeHtml="false"/>'/>
	...
	<div style="padding:2px;margin-top:10px;margin-top:10px;border:1px solid #efefef">
		...
		<table id='syserrorloggrid'></table>
