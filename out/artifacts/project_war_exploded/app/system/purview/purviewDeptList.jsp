		 ...
		 //==========================装载快捷键===============================//快捷键
				...
				$(document).ready(function(){
					var setting = {
							...
							async: {
								enable: true,  
								url:"openPurviewDept_treejson.action?purviewid=<s:property value='purviewid'/>",
								dataType:"json",  
								dataFilter: filter,
				...
				function setpurview(){
					asyncObjs();
					$.post('openPurviewDept_setpurview.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){
...
<div class="tools_nav">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
	      <tr>
          	<td align="left"><span id="title_span" style='font-size:14px;font-family:黑体'><img alt="权限组【部门】授权" src="iwork_img/shield.png" border="0">权限组【流程】授权</span></td>
...
<s:form name="editForm" id="editForm" action="openPurviewDept_setpurview" theme="simple" >
		 <s:hidden name="purviewid" />
		 <s:hidden name="deptList" id="deptList" /> 
</s:form>
</div>
