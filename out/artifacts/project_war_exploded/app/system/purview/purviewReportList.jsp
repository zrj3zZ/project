		...
		<script type="text/javascript">
				...
				$(document).ready(function(){
					var setting = {
							...
							async: {
								enable: true,  
								url:"openPurviewReporttreejson.action?purviewid=<s:property value='purviewid'/>",
								dataType:"json",  
								dataFilter: filter,
								autoParam:["id","type"]
							},callback: {
				...
				function setpurview(){
					asyncObjs();
					$.post('openPurviewReport_setpurview.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){ 
...
<s:form name="editForm" id="editForm" action="openPurviewReport_setpurview" theme="simple" >
		 <s:hidden name="purviewid" />
		 <s:hidden name="reportIds" id="reportIds" />
</s:form>
</div>
