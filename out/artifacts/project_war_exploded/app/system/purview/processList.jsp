		 ...
		 //==========================装载快捷键===============================//快捷键
				...
				$(document).ready(function(){
					var setting = {
							...
							async: {
								enable: true,  
								url:"openPurviewProcess_treejson.action?purviewid=<s:property value='purviewid'/>",
								dataType:"json",  
								dataFilter: filter,
								autoParam:["id","type"]
							},callback: {
				...
				function setpurview(){
					asyncObjs();  //获取选项信息
					$.post('openPurviewProcess_setpurview.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){
...
<s:form name="editForm" id="editForm" action="openPurviewProcess_setpurview" theme="simple" >
		 <s:hidden name="purviewid" />
		 <s:hidden name="processList" id="processList" />
</s:form>
</div>
