		...
		var api = art.dialog.open.api, W = api.opener;
				$(document).ready(function(){
					var setting = {
							...
							async: {
								enable: true,  
								url:"openPurviewUser_treejson.action?purviewid=<s:property value='purviewid'/>",
								dataType:"json",  
								dataFilter: filter,
				...
				function setpurview(){
					asyncObjs();
					$.post('openPurviewUser_setpurview.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){
...
<s:form name="editForm" id="editForm" action="openPurviewUser_setpurview" theme="simple" >
		 <s:hidden name="purviewid" />
		 <s:hidden name="userList" id="userList" /> 
</s:form>
</div>
