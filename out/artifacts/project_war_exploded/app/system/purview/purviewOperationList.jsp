...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		var api = art.dialog.open.api, W = api.opener;
		 jQuery(document).bind('keydown',function (evt){		
			...
			return false;
		            ...
		            $('#purgroup_save').attr('action','setpurviewOperation_do.action');
	...
	$(document).ready(function(){
			var setting = {
					...
					async: {
						enable: true, 
						url:"loadPurviewOperation_json.action?purviewid=<s:property value='purviewid'/>",
						dataType:"json", 
						dataFilter: filter,
		...
		//获得选择节点
 		...
 		//设置权限
				function setpurview(){
					asyncObjs();
					$.post('setpurviewOperation_do.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){
...
<div class="tools_nav">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
	      <tr>
          	<td align="left"><span id="title_span" style='font-size:14px;font-family:黑体'><img alt="权限组【操作】授权" src="iwork_img/shield.png" border="0">权限组【操作】授权</span></td>
          	<td style="text-align:right;padding:0px;padding-right:10px;padding-bottom:2px;">
				...
				<a href='javascript:this.location.reload();' class="easyui-linkbutton" iconCls="icon-cancel" plain="false">关闭</a>
          	</td>
           </tr>
	    </table>
	  </div>
...
<s:form name="editForm" id="editForm" action="setpurviewOperation_do.action" theme="simple" >
