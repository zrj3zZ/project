...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=0">
	...
	<link rel="stylesheet" type="text/css" href="iwork_css/jquerycss/jqm-datebox.min.css" /> 
	<link rel="stylesheet" type="text/css" href="iwork_css/jquerycss/jquery.datetimepicker.css" /> 
	...
	<script type="text/javascript" src="iwork_js/jqueryjs/jquery.datetimepicker.js"></script>
	...
	<script type="text/javascript">
       ...
       function uploadImgs(fieldName,serverId){
		...
		function showSubform(taskId,instanceId,subformId,subtitle){
			...
			var pageUrl = "weixin_subForm_showpage.action?actDefId="+actDefId+"&actStepDefId="+actStepDefId+"&prcDefId="+prcDefId+"&taskId="+taskId+"&instanceId="+instanceId+"&formId="+subformId;
		...
		function singleSave(){
			...
			var url = 'weixin_processRuntimeFormSave.action';
		...
		function openMonitorPage(){
			var actDefId = $("#actDefId").val();
					...
					var taskId = $("#taskId").val();
					var excutionId = $("#excutionId").val(); 
					window.location ="weixin_processInstanceMornitor.action?actDefId="+actDefId+"&instanceId="+instanceId+"&excutionId="+excutionId+"&taskId="+taskId;
		}
		function openOpinionPage(){
			var actDefId = $("#actDefId").val();
					...
					var taskId = $("#taskId").val();
					var excutionId = $("#excutionId").val(); 
					window.location ="weixin_showOpinionList.action?actDefId="+actDefId+"&instanceId="+instanceId+"&excutionId="+excutionId+"&taskId="+taskId;
		}
