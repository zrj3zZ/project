...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>     		
	...
	var selectedNodes;
		...
		function bohui(id,instanceid){
			...
			var pageUrl = "sanbu_plan_jgldsh_yijianAudit.action?instanceid="+instanceid+"&id="+id;
		...
		function audit(){
			...
			var url = "sanbu_plan_jgldsh_tjspAudit.action?instanceid="+instanceid+"&ids="+ids.join(',');
