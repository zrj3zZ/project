...
<title>IWORK综合应用管理系统</title> 
	...
	var api = frameElement.api, W = api.opener;	
		function add(){
			...
			var rid = $("#rowid").val();
			var opstr = $("#option").val();
			var url = "zg_saveA3Opinion_action.action";
			
			$.post(url,{instanceid:instanceid,rowid:rid,option:opstr},function(data){
				//alert(data);
               if(data=='ok'){
               		W.location.reload();	
		            closeWin(); 
		...
		<table width="100%" height="100%">
		   <tr>
		   		<td width="100%" height="100%" align="center">
		   			<textarea name="option" id="option" style="resize: none;width:98%;height:98%" rows="" cols=""></textarea>
		   		</td>
		   </tr>
		</table>
