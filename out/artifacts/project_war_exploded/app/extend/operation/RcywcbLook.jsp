...
<body class="easyui-layout">
	...
	<form   id="iformMain" name="iformMain" method="post" action='saveIform.action'>
		...
		<span style="display:none">
			...
			<input type="hidden" name="formid" value="133" id="formid"/>
			<input type="hidden" name="instanceId" value="<s:property value="zInstanceId" />" id="instanceId"/> 
			<input type="hidden"  value="<s:property value="zInstanceId" />" id="INSTANCEID"/> 
			<input type="hidden" name="dataid" value="84" id="dataid"/> 
