...
<title>WBS</title>
	...
	<script type="text/javascript">
		...
		function onClick(event, treeId, treeNode, clickFlag){
			...
			var glfUUID = $("#glfUUID").val();	
			var pageUrl = encodeURI("sysDem_DataList.action?demUUID="+glfUUID+"&KHBH="+khbh+"&init_params=KHBH="+khbh+";KHMC="+khmc);			
...
<body class="easyui-layout">
    ...
    <div region="center" border="false"  align="center" style="border:0px solid #C0C0C0;height:100%;">
    	<iframe id="mainFrame" name="mainFrame" scrolling="no" frameborder="0" style="width:100%;height:100%;"></iframe> 
    </div>
 	<s:hidden name="glfUUID" id="glfUUID"></s:hidden>
