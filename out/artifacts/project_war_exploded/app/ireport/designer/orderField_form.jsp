  ...
  <head>  
    ...
    <body class="easyui-layout">
      <div region="center" border="false" style="padding:3px;margin-bottom:5px;overflow-y:auto;">
           <s:form name="editForm" id="editForm" action="ireport_designer_orderField_save.action" theme="simple">
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                      <td class="td_title">排序类型：</td><td class="td_data"><s:radio name="model.orderType" list="#{'ASC':'升序(ASC)','DESC':'降序(DESC)'}"></s:radio>&nbsp;<span style='color:red'>*</span></td>
                   </tr>
               </table>
