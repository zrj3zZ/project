...
<script type="text/javascript" src="iwork_js/analytics_index.js"></script>
	<script type="text/javascript">
		...
		function showProjectList(type, searchkey){
			var pageurl = encodeURI("zqb_gpfx_project_search.action?type="+type+"&searchkey="+searchkey); 
    ...
    <body class="easyui-layout">
      <div region="north" border="false" >
      	<div class="tools_nav">
      	<span style="float:right;padding-right:10px">图表|<a href="zqb_gpfx_project_report.action">表格</a></span>
      	</div>
