	...
	$(document).ready(function() {
		...
		var calendar = $('#calendar').fullCalendar({
			...
			eventClick:function(calEvent, jsEvent, view){//点击日程
			    ...
			    obj.editForm_iworkSchCalendar_wczt=calEvent.wczt ;
				obj.editForm_iworkSchCalendar_wcqk=calEvent.wcqk ;
				var dg = $.dialog({
					id:'dg_eventClick',
					title:'编辑日程',
					resize : false,
					iconTitle:false,
					content:"url:editSchCalendar.action?id="+obj.editForm_iworkSchCalendar_id,
					max:false,
					data:obj
				});
			},
			...
			eventDrop:function(calEvent, dayDelta, minuteDelta, allDay, revertFunc,jsEvent, ui, view) {//拖动日程
				...
				var msg = "您移动了"+tip+",确定修改吗?";
		  		if (confirm(msg) == true) {
			        ...
			        $("#editForm_iworkSchCalendar_wczt").val(calEvent.wczt);
			        $("#editForm_iworkSchCalendar_wcqk").val(calEvent.wcqk);
...
<s:form id ="editForm" name="editForm" action="saveSchCalendar"  theme="simple">
	...
	wczt:<s:textfield name="iworkSchCalendar.wczt"></s:textfield>
	wcqk:<s:textfield name="iworkSchCalendar.wcqk"></s:textfield>
