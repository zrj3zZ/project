...
<html>
  <head>  
	...
	function linkSub(id,pid){
	     var url = 'conn_design_param_input.action?id='+id+'&pid='+pid;
		 this.location = url;
	} 
	function add(){
	    var pid=$('#pid').val();
		var url = 'conn_design_param_addPage.action?inorout=input&pid='+pid;
		openDialog('添加',url);
	}
	//添加和编辑窗口
  ...
  <body class="easyui-layout">
     ...
     <div region="center" style="padding:3px;border:0px;">					
					<div>
						<table id="condition_grid" style="height:400px"  iconCls="icon-edit" singleSelect="false" idField="ID" url="conn_design_param_json.action?pid=<s:property value='id'  escapeHtml='false'/>&inorout=input" >
									<thead>
										<tr>
										    <th field="CK" checkbox=true></th>
											<th field="ID" width="50" align="left">序号</th>
											<th field="IN_TITLE" width="100" align="left">参数标题</th>
											<th field="IN_NAME" width="120" >参数名称</th>	
											<th field="IN_SOURCE" width="100" align="left" >参数来源</th>
