    ...
    String.prototype.trim=function()   
	{
	 ...
	 function ok(){
	   ...
	   $.post('process_opin_isOpinExist.action',{opin:str},function(data)
				    {
					    	if(data=='1'){
					    		document.getElementById("modform").action="process_opin_modOpinion.action"; 
     ...
     function cancel(){
       location.href="process_opin_modOpinion.action?code=0"; 
     }
	</script>
	<style type="text/css">
	textarea{
    ...
    <div id="all">
        ...
        <div id="content">
				<fieldset>
					...
					<textarea id="ta" name="newopin" maxlength="100" onKeyUp="check(this)" onKeyDown="check(this)"><s:property value="oldopin"/></textarea> 
	            </fieldset>
       </div>
       <input type="hidden" name="modindex" value='<s:property value="strindex"/>' />
       </form>
  </div>     
<!--修改小窗口结束  -->
  </body>
