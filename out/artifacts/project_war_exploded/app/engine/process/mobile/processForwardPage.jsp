			...
			<td  class="pageInfo">
						<fieldset data-role="controlgroup">
							<legend>请选择您要转发的人:</legend>
						     	...
						     	<td><a  href="ifrom_mb_radio_address_show.action?fieldName=receiveUser" data-mini="true" data-role="button" data-inline="true" data-rel="dialog" data-transition="pop">地址簿</a></td>
						     	</tr></table> 
						</fieldset>
					</td>
			</tr>
