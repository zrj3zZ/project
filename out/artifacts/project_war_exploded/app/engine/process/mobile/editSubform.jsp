...
<div data-role="footer" data-fullscreen="true" class="ui-bar" data-position="fixed">
<a href="javascript:dosave();" data-role="button" data-icon="check" data-mini="true" data-inline="true" >保&nbsp;&nbsp;存</a>
<a href="javascript:del();" data-role="button" data-icon="delete" data-mini="true" data-inline="true" >删除</a>
	</div>
</body>
</html>
