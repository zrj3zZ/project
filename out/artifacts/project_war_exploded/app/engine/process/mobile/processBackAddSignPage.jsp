					...
					<tr style="display:none" >
						<td  class="pageInfo">
								<fieldset data-role="controlgroup">
									<legend>抄送人:</legend>
								     	<table><tr>
								     	<td><s:textfield name="ccUsers" id="ccUsers"  theme="simple"/></td>
								     	<td><a href="index.html" data-icon="search" data-inline="true" data-role="button">地址簿</a></td>
								     	</tr></table>
								</fieldset>
						</td>
					</tr>
						...
						<tr>
							...
							<table width="100%"  border="0"> 
								...
								<tr>
									...
									<td  class="pageInfo"><a href="ifrom_mb_radio_address_show.action?fieldName=ccUsers" data-role="button" data-rel="dialog" data-transition="slide" data-inline="true">地址簿</a></td>
								</tr>
							</table>
							</td>
						</tr>
