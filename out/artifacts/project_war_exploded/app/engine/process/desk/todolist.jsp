   ...
   <s:iterator value="tasklist" status="st">
    <tbody>
    	<s:if test="isRead==1"> 
    		...
    		<s:elseif test="taskType=='Signs'">
    			<tr class="table-tr-notice" id="signs_<s:property value="taskId"/>"> 
			        <td class="row3"><s:property value="#st.index+1"/></td>
			        <td class="row1"><s:property value="ownerName"/></a></td>
			         <td class="task_title" onclick="openSignsPage('<s:property value="title"/>','<s:property value="actDefId"/>',<s:property value="instanceId"/>,<s:property value="excutionId"/>,<s:property value="taskId"/>);"><font class="black_font"><s:property value="title"/></font></td>
			        <td><ul class="inline-operatebar"> 
			        	<s:property value="operate" escapeHtml="false"/> 
			          </ul></td>
			        <td class="row2"><s:property value="%{getText('{0,date,yyyy-MM-dd HH:mm  }',{createDate})}"/></td>
      ...
      <s:elseif test="taskType=='Signs'">
    			<tr class="wr-table-td-inner" id="signs_<s:property value="taskId"/>"> 
			        <td class="row3"><s:property value="#st.index+1"/></td>
			        <td class="row1"><s:property value="ownerName"/></a></td>
			         <td class="task_title" onclick="openSignsPage('<s:property value="title"/>','<s:property value="actDefId"/>',<s:property value="instanceId"/>,<s:property value="excutionId"/>,<s:property value="taskId"/>);"><font class="black_font"><s:property value="title"/></font></td>
			        <td><ul class="inline-operatebar"> 
