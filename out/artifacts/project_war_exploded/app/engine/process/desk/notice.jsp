...
<body class="easyui-layout" >
	<!-- TOP标签区 -->
	 <div region="north" style="height:40px;padding:0px;border:0px;;border-bottom:1px solid #efefef;">
	   <div class="process_header">
	     <div class="process_head_tab_box"> 
		   <a class="process_head_tab" title="显示所有待审批流程未读的抄送任务或通知" href="process_desk_index.action"><s:text name="process.desk.todo"/><span id="taskNum"></span></a>
		     ...
		     <a class="process_head_tab_active"  title="显示所有接收的抄送及流程通知任务"  href="process_desk_notice.action"> <s:text name="process.desk.notice"/><span id="NoticeNum"></span></a>
