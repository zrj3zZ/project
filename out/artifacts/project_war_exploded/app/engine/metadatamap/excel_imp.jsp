...
<title>IWORK综合应用管理系统</title>
	...
	<script type="text/javascript">
		...
		function doUpfile(){
			...
			if(fileExt=='xls'||fileExt=='et'||fileExt=='xlsx'){
				submitForm(); 
			}else{
...
<div region="north" border="false" > 
	...
	<div region="center"border="false" >
		 <s:form  method ="POST" name="upfileForm" id="upfileForm"  action="sysEngineMetadataMap_doExcelImp.action" theme="simple"  enctype ="multipart/form-data">
