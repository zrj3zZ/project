...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		if(checkvalue!=null&&checkvalue!=''){
			$("#XM",artDialog.open.origin.document).val(checkvalue);
			closeWin();
		}else{
	...
	function doSearch(){
		...
		var customerno = $("#username").val();
		var seachUrl = encodeURI("gzrzxzq.action?username="+ customername );
									...
									<thead>
										<tr role="rowheader" class="ui-jqgrid-labels">
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_CUSTOMERNAME" style="width: 23%;">
												...
												<div id="jqgh_dictionary_list_grid_CUSTOMERNAME" class="ui-jqgrid-sortable" style="font-size: 12px;"> 账号
												<span style="display:none" class="s-ico">
													<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
													<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
												</span>
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_CUSTOMERNO" style="width: 14%;">
												<span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												<div id="jqgh_dictionary_list_grid_CUSTOMERNO" class="ui-jqgrid-sortable" style="font-size: 12px;"> 姓名
												<span style="display:none" class="s-ico">
													<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
													<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
												</span>
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_USERNAME" style="width: 13%;">
												<span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												<div id="jqgh_dictionary_list_grid_USERNAME" class="ui-jqgrid-sortable" style="font-size: 12px;">部门
													<span style="display:none" class="s-ico">
														<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
														<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
													</span>
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_TEL" style="width: 13%;">
												<span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												<div id="jqgh_dictionary_list_grid_TEL" class="ui-jqgrid-sortable" style="font-size: 12px;">手机
													<span style="display:none" class="s-ico">
														<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
														<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
													</span>
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_CUSTOMERDESC" style="width: 34%;">
												<span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												<div id="jqgh_dictionary_list_grid_CUSTOMERDESC" class="ui-jqgrid-sortable" style="font-size: 12px;">邮箱
													<span style="display:none" class="s-ico">
														<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
														<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
													</span>
								...
								<table cellspacing="0" cellpadding="0" border="0" id="dictionary_list_grid" tabindex="1" role="grid" aria-multiselectable="false" aria-labelledby="gbox_dictionary_list_grid" class="ui-jqgrid-btable" style="width: 100%;font-size: 12px;">
									<tbody>
										...
										<tr class="ui-widget-content jqgrow ui-row-ltr" onmouseover="setBeckGroundYes(this);" onmouseout="setBeckGroundNo(this);">
											<td><input type="radio" value="<s:property value="username"/>" name="chk_list"></td>
											<td aria-describedby="dictionary_list_grid_CUSTOMERNAME" title="<s:property value="userid"/>" style="text-align:left;" role="gridcell"><s:property value="userid"/></td>
											<td aria-describedby="dictionary_list_grid_CUSTOMERNO" title="" style="text-align:left;" role="gridcell"><s:property value="username"/></td>
											<td aria-describedby="dictionary_list_grid_USERNAME" title="" style="text-align:left;" role="gridcell"><s:property value="departmentname"/></td>
											<td aria-describedby="dictionary_list_grid_TEL" title="" style="text-align:left;" role="gridcell"><s:property value="mobile"/></td>
											<td aria-describedby="dictionary_list_grid_CUSTOMERDESC" title="<s:property value="email"/>" style="text-align:left;" role="gridcell"><s:property value="email"/></td>
										</tr>
										</s:iterator>
									</tbody>
								</table>
