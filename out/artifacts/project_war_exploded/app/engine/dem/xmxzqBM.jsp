...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		if(checkvalue!=null&&checkvalue!=''){
			$("#BM",artDialog.open.origin.document).val(checkvalue);
			closeWin();
		}else{
	...
	function doSearch(){
		var customername = $("#departmentname").val();
		var customerno = $("#departmentname").val();
		var seachUrl = encodeURI("gzrzxzqBM.action?departmentname="+ customername );
								...
								<table width="100%" cellspacing="0" cellpadding="2">
									<tbody>
										<tr>
											...
											<td><input type="text" form-type="al_textbox" value="${departmentname}" id="departmentname" name="departmentname" style="width:150px;font-size:12px;" class="{required:false}"></td>
									...
									<thead>
										<tr role="rowheader" class="ui-jqgrid-labels">
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_CUSTOMERNAME" style="width: 23%;">
												...
												<div id="jqgh_dictionary_list_grid_CUSTOMERNAME" class="ui-jqgrid-sortable" style="font-size: 12px;"> 部门编号
												<span style="display:none" class="s-ico">
													<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
													<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
												</span>
											...
											<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="dictionary_list_grid_CUSTOMERNO" style="width: 14%;">
												<span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												<div id="jqgh_dictionary_list_grid_CUSTOMERNO" class="ui-jqgrid-sortable" style="font-size: 12px;">部门名称
												<span style="display:none" class="s-ico">
													<span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span>
													<span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span>
												</span>
								...
								<table cellspacing="0" cellpadding="0" border="0" id="dictionary_list_grid" tabindex="1" role="grid" aria-multiselectable="false" aria-labelledby="gbox_dictionary_list_grid" class="ui-jqgrid-btable" style="width: 100%;font-size: 12px;">
									<tbody>
										...
										<tr class="ui-widget-content jqgrow ui-row-ltr" onmouseover="setBeckGroundYes(this);" onmouseout="setBeckGroundNo(this);">
											<td><input type="radio" value="<s:property value="departmentname"/>" name="chk_list"></td>
											<td aria-describedby="dictionary_list_grid_CUSTOMERNAME" title="<s:property value="companyno"/>" style="text-align:left;" role="gridcell"><s:property value="companyno"/></td>
											<td aria-describedby="dictionary_list_grid_CUSTOMERNO" title="<s:property value="departmentname"/>" style="text-align:left;" role="gridcell"><s:property value="departmentname"/></td>
