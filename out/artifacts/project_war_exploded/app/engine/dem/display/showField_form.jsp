   ...
   <link rel="stylesheet" type="text/css" href="iwork_css/jquerycss/icon.css">
    ...
    <body class="easyui-layout">
      <div region="center" border="false" style="padding:3px;margin-bottom:5px;overflow-y:auto;">
           <s:form name="editForm" id="editForm" action="sysDem_display_save.action" theme="simple">
               <table width="100%" border="0" cellspacing="0" cellpadding="10">
                   ...
                   <tr>
                      <td class="td_title">字段标题：</td><td class="td_data"><s:textfield cssStyle="width:200px;"  cssClass="{required:true}"  name="model.title"/>&nbsp;<span style='color:red'>*</span></td>
                   </tr> 
                   <tr>
                      <td class="td_title">是否显示：</td><td class="td_data"><s:radio name="model.isDisplay"  cssClass="{required:true}"  list="#{'1':'是','0':'否'}"></s:radio>&nbsp;<span style='color:red'>*</span></td>
                   </tr>
                   <tr>
                      <td class="td_title">显示宽度：</td><td class="td_data"><s:textfield cssStyle="width:80px;"  cssClass="{number:true,required:true}"  name="model.width"/>&nbsp;<span style='color:red'>*</span></td>
                   </tr>
               </table> 
