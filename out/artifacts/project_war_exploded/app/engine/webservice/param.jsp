...
<body class="easyui-layout">
            ...
            <s:form name="editForm" id="editForm" action="web_service_param_save.action"  theme="simple">
            	...
            	<tr>  
            		...
            		<tr>
            			...
            			<td class="form_data">
            			<s:textfield name="param.value"  ></s:textfield>
            		</tr>
            		<tr>
            			<td class="form_title">是否必填:</td>
            			<td class="form_data">
            			<s:radio  name="param.required"   list="#{'1':'是','0':'否'}"></s:radio>
            		</tr>
            		<tr>
            			<td class="form_title"><span style="color:red;">*</span>参数类型:</td>
            			<td class="form_data">
            				<s:select name="param.type" list="#{'NUM':'数值','CHAR':'文本','DATE':'日期','STRUCTURE':'参数结构'}"></s:select>
            			</td>
            		</tr>
            		</s:if>
            		<s:else>
