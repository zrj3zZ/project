...
<body class="easyui-layout">
            ...
            <s:form name="editForm" id="editForm" action="web_service_save.action"  theme="simple">
				...
				<tr id="contentTypeTr">
					...
					<td  class="form_data">   
							<s:radio  name="model.contentType" cssStyle="border:0px;" onclick="setContentType();" cssClass="{maxlength:32,required:true}" listKey="key" listValue="value"  list="#{'1':'XML','2':'JSON'}" value="model.contentType" theme="simple"/>
					</td>
				</tr>
