...
(function($) {
          ...
          Autocomplete.prototype = {
                    ...
                    processSuggestions : function(me) {
                              ...
                              var siteLoc;
                              if (me.options.params['siteLocale'].indexOf('_OT')!=-1)
                                        siteLoc = me.options.params['siteLocale'].replace('_OT', '_US');
                              else
                                        siteLoc = me.options.params['siteLocale'];

                              var url = me.options.serviceUrl + "?siteLocale="+siteLoc+"&where="+me.options.params['where'];
