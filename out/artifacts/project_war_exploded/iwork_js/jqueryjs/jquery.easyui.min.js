...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"�����Ϊ��.",invalidMessage:null,rules:{email:{validator:function(_2fb){
...
},message:"�������ʼ���ַ."},url:{validator:function(_2fc){
...
},message:"������URL��ַ."},length:{validator:function(_2fd,_2fe){
var len=$.trim(_2fd).length; 
return len>=_2fe[0]&&len<=_2fe[1];
},message:"������һ�� {0}��{1}֮���ֵ."},remote:{validator:function(_2ff,_300){
var data={};
data[_300[1]]=_2ff;
