...
function end_Drag(){
	if(this._afterDrag()){
		...
		var sortIndex = DragUtil.getSortIndex();
		save_Drag_Sort(sortIndex);
	}
	return true;
}

//保存拖动顺序
function save_Drag_Sort(sortIndex){
	 var url = "syspersion_saveProcessAndReportCenterSort.action";  
     var pars = "persion_process_launch_center_sort = " + sortIndex;  
