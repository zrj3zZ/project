...
<link rel="stylesheet" type="text/css" media="screen" href="iwork_css/jquerycss/validate/screen.css" />
	...
	<script type="text/javascript" src="mobile/assets/js/common.js"></script>
	...
	var mainFormValidator;
		...
		function openDictionary(id){
			var pageUrl = "wechat_dic_show.action?dictionaryUUID="+id;
		...
		function openSubDictionary(id){
			var pageUrl = "wechat_dic_show.action?dictionaryId="+id;
			art.dialog.open(pageUrl,{
				id:'dg_dictionary',  
			    title:'数据字典',
				background: '#999', // 背景色 
	 	...
	 	function back(){ 
			...
			var pageUrl = "wechat_pr_subform.action?actDefId="+actDefId+"&actStepDefId="+actStepDefId+"&prcDefId="+prcDefId+"&taskId="+taskId+"&instanceId="+instanceId+"&formId="+formId;
	 		redirectUrl(pageUrl);  
	 	}
	 	function del(){ 
				$.ajax({ 
