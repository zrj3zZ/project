...
function openTaskPage(title,actDefId,instanceId,excutionId,taskId){
	...
	function cxwenti(){
		var a=$("#searchKey").val();
	    var url = "weixin_xxquesion_account.action";
      	 $.post(url, {title : a
		}, function(rText) {
			$("#list").html(rText); 
			$("#tip").text("已到达底部");
	     ...
	     <div class="weui_search_bar" id="search_bar">
	      <form class="weui_search_outer">
	        <div class="weui_search_inner">
	          ...
	          <input type="text" name="searchKey" class="weui_search_input" style="color:#000" id="searchKey" placeholder="搜索" />
	        </div>
	      ...
	      <a href="javascript:willid(0);" onclick="cxwenti()" class="weui_search_cancel" id="search_cancel">搜索</a>
	    </div>
      </div>
