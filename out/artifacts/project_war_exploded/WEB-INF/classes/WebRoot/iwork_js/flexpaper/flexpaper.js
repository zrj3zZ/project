...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:THEME_URL+"/js/flexpaper/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:THEME_URL+"/js/flexpaper/");
    _localeDirectory 	= (config.localeDirectory!=null?config.localeDirectory:THEME_URL+"/js/flexpaper-2.2.1/");
