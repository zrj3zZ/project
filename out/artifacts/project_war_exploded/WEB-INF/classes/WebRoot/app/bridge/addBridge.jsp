...
<body class="easyui-layout">
            ...
            <s:form id="editForm" name="editForm" action="conn_bridge_save.action" method="post" theme="simple">
            	<table width="100%"  border="0" cellpadding="5" cellspacing="0"> 
            	
            		<tr>  
            			<td class="form_title" style="vertical-align:top"><span style="color:red;">*</span>连接名称:</td>
            			<td class="form_data"><input type="text" name="model.bridgeName" value="<s:property value="model.bridgeName"/>" id="editForm_model_bridgeName" class="{required:true}" style="width:350px"/></td>
            		</tr> 
            		<tr>
            		...
            		<tr>
            			...
            			<td  class="form_data"> 
            				<input type="text" name="model.delay" value="<s:property value="model.delay"/>" id="editForm_model_delay" style="width:230px" class="{maxlength:32,required:true}"/> <font color="#000000;">毫秒</font>
            			</td>
            		</tr> 
            		<tr>
            			<td class="form_title">连接状态:</td>
            			<td class="form_data">
                ...
                <input type="hidden" name="model.id" value="0" id="editForm_model_id"/>
