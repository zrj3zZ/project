...
<html>
	...
	<script type="text/javascript">
		...
		function doSubmit(){
			...
			var pageUrl = "ireport_rt_doSqlSearch.action?" + msg;
		...
		function exportExcel() {
			$("#editForm").attr("action","ireport_rt_sqlReportExportExcel.action");
			$("#editForm").submit();
		}
		function newWin(){
	...
	<body class="easyui-layout">
		...
		<div region="north" border="false"  style="overflow:hidden;" > 
			<div class="nav_bar">
				<img src="iwork_img/table.png" border="0"/> 报表中心>> <s:property value="title" escapeHtml="false" />
				<span><a href="###" onclick="exportExcel()"><img src="../iwork_img/file/excel.gif" border="0"/>导出Excel</a> <a href="###" onclick="newWin()"><img src="iwork_img/blank2.gif"  target="_blank" border="0"/>在新窗口显示</a> </span>
			</div>
		</div>
		<div region="center" style="padding: 3px; padding-top: 3px; border: 0px;">
			...
			jQuery("#ireport_grid").jqGrid({
		   		url:'ireport_rt_doSqlSearch.action?reportId=<s:property  value="reportId" escapeHtml="false" />',
				datatype: "json",
				//mtype: "POST",
				rownumbers:true,
				viewrecords: true,
