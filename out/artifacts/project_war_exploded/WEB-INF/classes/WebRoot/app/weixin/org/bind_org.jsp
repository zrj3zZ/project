...
<body >
        ...
        <div class="InputBlockBody">
            ...
            <table class="InputLine">
                <tr>
                    ...
                    <td class="right" align="left">
                        <input name="userid" type="text" id="userid" class="NoneInput90" maxlength="16"/>
                    </td>
            ...
            <table class="InputLine">
                <tr>
                    ...
                    <td class="right" align="left">
                        <input type="password" id="PwdA" name="password" maxlength="6" class="NoneInput90" />
                    </td>
                    <td class="right_margin">
                    </td>
                </tr>
            ...
            <table class="InputLine">
            	...
            	<td> <input type="text" class="NoneInput90"  style="width:60px" name="identifyCode" id="identifyCode"  onkeydown="if(event.keyCode==13) doBind();"  onfocus="$(this).val('')" onblur="if(!value){$(this).val('验证码')}">
            	</td>
            	<td><img id="identifyPic"  alt="看不清楚？点击换一张"  src="weixin_identifyCode.action" onclick="changeValidateCode(this)" class="identifier"  />
            	</td>
            	</tr></table>
                    </td>
    ...
    <div class="btnDIV">
        <input type="button" class="btn" style="width:300px" id='BtnSubmit' value="提交" style="" onclick="javascript:doBind();"/>
    </div>
        </div>
    </div>
    <div id="AssureWord">
