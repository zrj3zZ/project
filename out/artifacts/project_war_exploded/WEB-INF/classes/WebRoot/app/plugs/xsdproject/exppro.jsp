...
<script type="text/javascript">
	...
	function doSubmit() {
		...
		temp=temp.join(',');
		var pageUrl = "xsd_zqb_project_exppro.action?zcPro="+temp;
									...
									<table class="ke-zeroborder" border="0" cellpadding="0"
										...
										<tbody>
											...
											<tr id="itemTr_1913">
												...
												<td class="td_data" id="data_TZBT" width="150px">
													<input id="gzlxr" type="checkbox" value="GZLXR" name="box">&nbsp;股转联系人
												</td>
												<td class="td_data" id="data_TZBT" width="150px">
													<input id="gzlxdh" type="checkbox" value="GZLXDH" name="box">&nbsp;股转联系电话
												</td>
												<td class="td_data" id="data_TZBT" width="150px">
													<input id="gzyjdz" type="checkbox" value="GZYJDZ" name="box">&nbsp;股转邮件地址
												</td>
											</tr>
											<tr id="itemTr_1913">
												<td class="td_data" id="data_TZBT" width="150px">
													<input id="yjsbsj" type="checkbox" value="YJSBSJ" name="box">&nbsp;预计申报时间
												</td>
												<td class="td_data" id="data_TZBT" width="150px">
												</td>
												<td class="td_data" id="data_TZBT" width="150px">
