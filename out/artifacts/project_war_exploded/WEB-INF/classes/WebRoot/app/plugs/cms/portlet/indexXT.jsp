...
<script type="text/javascript">
	$(function(){
	        //加载导航树
		    $('#portlettree').tree({   
                url: 'cmsPortletXtAction!openjson.action',
                ...
                if(node.attributes.type=='group'){         
                 document.location.href = "cmsPortletXtAction!index.action?gname="+encodeURI(encodeURI(node.text)); 
              	}
                }, 
			...
			//加载栏目表
		   	$('#portletgrid').datagrid({
            	url:"cmsPortletXtAction!portletgrid.action?gname="+encodeURI(encodeURI('<s:property value='gname' escapeHtml='false'/>')),
			    loadMsg: "数据加载中，请稍后...",
			    fitColumns: true,
			    singleSelect:true,
			    nowrap:false,
...
<body class="easyui-layout">
	...
	<!-- 编辑窗口 -->
    <div id="portletdialog" class="easyui-dialog" title="栏目信息维护" icon="icon-edit"  style="width:400px;height:480px;padding-top:70px;background: #fafafa;" buttons="#dlg-buttons">			 
      <div id="portletTab"  class="easyui-tabs" fit="true" plain="true" border="false" style="height:100%;width:380px;">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style='margin-top:5px;display:none'>
        <tbody id=ROW_SUB>
        <tr>
