	   ...
	   //查看执行详细信息或者编辑数据
		function openPlanListItem(instanceid){
		   ...
		   //$("#mount").val();
			...
			var pageUrl = "openFormPage.action?formid="+formId+"&instanceId="+instanceid+"&demId="+demId+"&BLANCEAMOUNT="+instanceid;
...
<body >
             	...
             	<div class="tableList">
             		<table width="100%">
             			...
             			<th><input type="checkbox" id="ckb_selectAll" onclick="selectAll()"
							...
							<th>日期</th>
             				<th><s:property value="baseinfo.invoicePerformCollectionString"/>（<s:property value="baseinfo.currencyString"/>）</th>        				
             				<th>内容摘要</th>
             				<th>附件</th>
             				<th>操作</th>
             			</tr>
            ...
            <s:hidden name="itemno" id="itemno"></s:hidden>
             <s:hidden name="mount" id="mount"></s:hidden>
            </s:form>
