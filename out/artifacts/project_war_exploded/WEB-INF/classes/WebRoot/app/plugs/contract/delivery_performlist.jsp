...
<body >
            ...
            <div class="topCss">
             ...
             <div class="listCss">
             	...
             	<!--<a  href="###" style="margin-left:1px;margin-right:1px"  onclick="addPlan()"  class="easyui-linkbutton" plain="true" iconCls="icon-add">添加执行情况</a>
             		<a  href="###" style="margin-left:1px;margin-right:1px"  onclick="delcfm()"  class="easyui-linkbutton" plain="true" iconCls="icon-remove">删除</a>
             	-->
             	</div>
             	<div class="tableList">
             		<table width="100%">
             			...
             			<s:iterator value="list">
							...
							<input name="ckb_selectAll" type="checkbox"
             				...
             				<td><s:property value="DELIVERED_DATE"/></td>
             				<td><s:property value="DELIVERED_GOODS"/></td>
             				<td><s:property value="CREATENAME"/></td>
             				<td><s:property value="CREATE_DEPT_NAME"/></td>
