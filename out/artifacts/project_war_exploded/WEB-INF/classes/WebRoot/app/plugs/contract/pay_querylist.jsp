...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>
		...
		$("#pp").pagination({
			   ...
			   // sum:<s:property value="sum"/>;
			    ...
			    onSelectPage:function(pageNumber, pageSize){
			    	var pageUrl="iwork_query_pay.action?pageSize="+pageSize+"&pageNumber="+pageNumber+"&eventContract="+<s:property value="eventContract"/>+"&pactNo="+$("#pactNo").val()+"&pactName="+$("#pactName").val()
	...
	function doSearch(){ 
            ...
            // alert(sum);
		     ...
		     window.location.href="iwork_query_pay.action?pactNo="+pactNo+"&pactName="+pactName+"&sum="+sum+"&eventContract="+eventContract+"&ContractProperties="+ContractProperties+"&contractNature="+contractNature+"&year="+year;   
    }
           ...
           <fieldset width="100%">
            <legend>查询</legend>    
            		<table width="100%">
            			<tr>
            				<td>合同编号</td>
            				<td><input type="text" id="pactNo" value="<s:property value="pactNo"/>"/> </td>
            				<td>合同名称</td>
            				<td><input type="text" id="pactName" value="<s:property value="pactName"/>"/> </td>
	                ...
	                <table width="100%">
             		...
             		<s:iterator value="list">            			
             		 <tr>
	            		...
	            		<td><a href="iwork_contract_baserceivablequery.action?instanceId=<s:property value="INSTANCEID"/>&itemno=<s:property value="PACTNO"/>" target="_self"><s:property value="PACTNO"/></a></td>           		
	            		<td><s:property value="PACTTITLE"/></td>	
	            		<td><s:property value="CONTACTTYPE"/></td>
	            		<td><s:property value="PACTSUN"/></td>
	            		<td><s:property value="YFZK"/></td>
	            		<td><s:property value="YFKJE"/></td>
	            		<td><s:property value="WFKJE"/></td>	           		
             		</tr>
             		</s:iterator>           			
             		</table>
             </div>
            ...
            <s:hidden name="sum" value="2"></s:hidden>
            </s:form>
