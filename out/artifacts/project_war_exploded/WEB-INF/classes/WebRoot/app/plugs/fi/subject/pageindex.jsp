	...
	<script type="text/javascript"> 
		...
		function setSubjectList(event, treeId, treeNode, clickFlag){
			...
			var setting = {
					...
					async: {
						enable: true, 
						url:"iwork_fi_subject_list_Json.action?typeid="+treeNode.FYLBBH+"&typekey="+$("#typekey").val(),
						dataType:"json" 
					}, 
					callback: {
		...
		function doSubjectSet(){
			...
			var zTree = $.fn.zTree.getZTreeObj("subject_tree");
 			...
 			for(var i=0;i<nodes.length;i++){
 				...
 				var tmp = nodes[i].SUBJECT_ID;
 				if(tmp!=''){
 					arr.push(tmp);
 				}
 			}
 			var subjectIds = arr.join(",");
 			 if(confirm("确定执行费用科目授权吗？"))
 			   {
 				//===请求服务器== 
	...
	<div region="center" style="padding:0px;border:0px;">
		<div class="easyui-layout" fit="true">
			...
			<div region="west"  style="width:180px;border:0px;background:#efefef;">
				...
				<div class="easyui-layout" fit="true">
			<div region="west"  style="width:200px;border:0px;background:#fcfcfc"> 
					<div  class="selectDiv">
