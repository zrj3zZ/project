...
<title>IWORK综合应用管理系统</title>
	...
	function sentLetter(){
   	...
   	var taskid = document.getElementById('sentUserId');
   ...
   //
   function resentLetter(){
   	var form =  document.getElementById('editForm');
   	var flag = checkValidate();
   	if(flag==true){
   		form.action ="iwork_email_reforward.action";
   		form.submit();
   		window.opener.location.href="app/plugs/email/send_tips.jsp";
		window.close();
   	}else{
...
var id = counts.val();
alert(id);
form.action ="iwork_mail_savetounsend.action?forwardid="+id;
   		form.submit();
   		window.opener.location.href="app/plugs/email/send_tips.jsp";
		window.close();
		...
		<td>
			<div>
		 		...
		 		<tr>
		 			...
		 			<td class="headData"><s:textfield tabindex="1" name="model._to" id="_to" theme="simple" cssClass="{maxlength:1000,required:true}" >
 <s:iterator value="list" status="status"><s:property value="_too"/></s:iterator>

  </s:textfield> <img src="iwork_img/mans.gif"/><a href="###" onclick="multi_book('','','','','','','','','_to');" title="多选地址薄" class="easyui-linkbutton" plain="true"></a></td>
		 		    
		 		</tr> 
		 		<tr>
		 			<td class="headTitle">发送人</td>
		 			<td class="headData"><s:textfield tabindex="2"  name="model._mailFrom" id="_mailFrom" theme="simple" 
...
cssClass="{maxlength:1000,required:false}"><s:iterator value="list" status="status"><s:property value="_cc"/></s:iterator></s:textfield> <a href="###" onclick="multi_book('','','','','','','','','_cc');" title="多选地址薄" 
...
cssClass="{maxlength:200,required:true}"><s:property value="_title"/></s:textfield> </td>
		 		</tr>
		 		<tr>
		 		...
		 		<tr>
		 			...
		 			<td class="headData"> 
						<textarea name="model._content" id="htmlEditor"  cols="80" rows="12" >111222<s:property value="_content"/></textarea>
					</td>
		 		</tr>
		...
		<input type="hidden" id="sentUserId" name="sentUserId" value="<s:property value="id"/>"/>
