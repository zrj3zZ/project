...
<title>信披自查反馈</title>
	...
	$().ready(function() {
		...
		function saveForm() {
			...
			var bz;
			var pz;
			var url = "zqb_cxdd_updateCxddfk.action?CUSTOMERNO=" + khbh + "&TZGGID=" + ggid;
		...
		<s:form id="editForm" name="editForm" theme="simple">
			...
			<div id="border">
				<table style="margin-bottom:5px;" class="ke-zeroborder" border="0"
					...
					<tbody>
						<tr>
							<td class="formpage_title">持续督导日常工作反馈</td>
						</tr>
						<tr>
							                ...
							                <s:iterator value="list" status="ll">
							                	<s:if test="#ll.index-1<0||CUSTOMERNO!=list[#ll.index-1].CUSTOMERNO">
									                	...
									                	<s:elseif test="ORGUSERROLRID==3 && LOCKSTATUS!=1">
									                		<tr class="cell">
									                			<td>情况说明：<textarea id="BZ<s:property value="COUNT"/>" class="{maxlength:256,required:false} " style="width:300px;height:15px;" value="" name="BZ<s:property value="COUNT"/>"><s:property value="BZ"/></textarea></td>
									                		</tr>
									                	</s:elseif>
									                	...
									                	<s:elseif test="ORGUSERROLRID!=3 && LOCKSTATUS!=1">
									                		<tr class="cell">
									                			<td>批注：<textarea id="PZ<s:property value="COUNT"/>" class="{maxlength:256,required:false} " style="width:300px;height:15px;" value="" name="PZ<s:property value="COUNT"/>"><s:property value="PZ"/></textarea></td>
									                		</tr>
									                	</s:elseif>
												</s:if>
												<s:else>
												...
												<input type="hidden" id="khbh" name="khbh" value="${hfr}"/>
											</s:iterator>
							                <s:iterator value="feedBackList" status="ll">
							                <s:if test="#ll.index-1<0||CUSTOMERNO!=list[#ll.index-1].CUSTOMERNO">
					                			<s:if test="list.size()==0">
													<tr class="cell">
									                	<td><font size="2.5">客户名称:<s:property	value="CUSTOMERNAME"/></font></td>
									                </tr>
												</s:if>
							                	<tr class="cell">
							                		<td class="breakword"><s:property	value="QUESTION"/></td>
			...
			<input type="hidden" id="forSize" name="forSize" value="${feedBackList.size()+list.size()}" class="{string:true}"/>
