	...
	<script type="text/javascript">
		...
		function initTree(){
			var setting = {
						...
						async: {
							enable: true, 
							url:"multibook_orgjson.action?parentDept=<s:property value='parentDept' escapeHtml='false'/>&currentDept=<s:property value='currentDept' escapeHtml='false'/>&startDept=<s:property value='startDept' escapeHtml='false'/>&input=<s:property value="input"/>", 
							dataType:"json",
			...
			function insertData(){
				...
				//var zTree = $.fn.zTree.getZTreeObj("multitree");
	 			...
	 			for(var i=0;i<nodes.length;i++){
	 				...
	 				pushData(userNameObj,targetUserName,nodes[i].usernam);
