...
<html>
  <head>
    <title>问题详情</title>
    <link type="text/css" rel="stylesheet" href="iwork_css/iwork/public.css"/>
    <link type="text/css" rel="stylesheet" href="iwork_css/iwork/index2011.css"/>
    <link type="text/css" rel="stylesheet" href="iwork_css/formstyle.css"/>
    <link type="text/css" rel="stylesheet" href="iwork_css/iwork/ext-all.css"/>
    <link type="text/css" rel="stylesheet" href="iwork_css/iwork/tips.css"/>
    <link rel="stylesheet" type="text/css" href="iwork_css/iwork/oaknow.css"/>
    <link rel="stylesheet" type="text/css" href="iwork_css/iwork/oaknow_content.css"/>
...
.best_con{
	padding: 5px;
	width: 760px;
	border: 1px solid #87CD70;
	margin:5px auto;
	color: #333333;
	text-align:left;
}
.line_clean{ 
	line-height:1px; height:1px; overflow:hidden; border-top:1px solid #999999;
	width:760px;
}
.span_m{
	font-size:12px; color:#777777;
}
.top_bg{background:url(/iwork_img/know/top_bg.jpg) repeat-x;height:61px;position:relative;width:100%;}
.top_rgt{right:0px;top:0px;background:url(/iwork_img/know/top_rgt.jpg) no-repeat right top;width:369px;height:54px;padding-right:34px;float:right;}
.holdout_span_c1{color: #000099;}
.holdout_span_c1:hover {color: #CC0000;cursor:pointer;}	 
  </style>
  <style>
  ...
  var mainFormValidator;
  $().ready(function() {
  mainFormValidator =  $("#talkForm"+$("aid").val()).validate({
   });
   mainFormValidator.resetForm();
  });
  //编辑问题
    function editQuestion(qid){
			var url = 'know_edit_question.action?qid='+qid;
			art.dialog.open(url,{
					id:'dg',
					cover:true,
					title:'编辑问题',
  ...
  //打开评论
    ...
    document.getElementById('talk_span_'+aid).innerHTML = '<span class=\"holdout_span_c1\" onclick="talkclose(\''+aid+'\');">评论</span>';
  } 
 //关闭评论
 function talkclose(aid){ 	
 	document.getElementById('comment_div_'+aid).style.display = 'none'; 	
 	document.getElementById('talk_span_'+aid).innerHTML = '<span class=\"holdout_span_c1\" onclick="talkopen(\''+aid+'\');">评论</span>'; 
  }
 //保存评论
   talkErrorFunc=function(){
           lhgdialog.tips("评论失败！",2);
      }
   talkSuccessFunc=function(responseText, statusText, xhr, $form){
           if(responseText=="ok"){
              lhgdialog.tips("评论成功！",2);
              location.reload();
           }
      }
 ...
 function deletetalk(tid){
 	  lhgdialog.confirm("确定删除该评论？",function(){
 ...
 $(function() {
   ...
   /*保存回答*/
    function save(){
        ...
        if(ACONTENT=="" || ACONTENT=="请填写您的回答"){
              lhgdialog.tips("请输入回答内容！",2);
               $('#ACONTENT').focus();
              return ;
          }
        if(INVITEDMAN=='多个被邀请回答人请用空格分隔'){
                       $('#INVITEDMAN').val('');
                       INVITEDMAN = '';  
                  }
  ...
  //删除回答
    function deleteAnswer(aid,able){
        if(able==0){
            lhgdialog.tips("您邀请了其他人回答该问题，不能删除",2);
            return;
        }
        else{
            lhgdialog.confirm("确定删除该回答？",function(){
  ...
  //选为最佳回答
   function setBestAnswer(aid){
   		lhgdialog.confirm("确定设置该回答为最佳答案？",function(){
       					...
       					<td align="left" valign="top" style="padding-left:20px;">
       						<s:if test="qtype==0 && loginuid==quid">
       					 	<div style="margin-top:7px; margin-bottom:8px;vertical-align:bottom;">
       					 		<img src="/iwork_img/know/edit_question.jpg"/><span class="holdout_span_c1" style="padding-left:5px;" onClick="editQuestion(<s:property value='qid'/>);">编辑我的提问</span>	
       					 	</div>
       					 	</s:if>
       					</td>                         
...
<!-- 我来回答 -->       	
     ...
     <s:form name="editForm" id="editForm" action="know_save_answer.action" method="post" theme="simple"> 	          
       		...
       		<table border="0" cellspacing="0" cellpadding="0" width="650" id="answer_tab">                     
       			<tr>                         
       				<td align="left" style="width:140px;">
       				 ...
       				 <span class="holdout_span_c1" onclick="showman();" title="邀请其他人回答这个问题">邀请回答人</span>
       				</td>                         
       				<td align="left">                             
       					<table border="0" cellpadding="0" cellspacing="0" id="line_space" style="visibility:hidden;">
       						<tr>
       							<td align="left" style="width:359px;">
       							    <s:textfield id="INVITEDMAN" name="answer.invitedman"  onkeyup="getuserbycode(this);" cssClass="actionsoftInput {string:true,required:true}" cssStyle="color:#D1D1D1;width:339px;" onblur="dropFocus(this,'多个被邀请回答人请用空格分隔');" onfocus="getFocus(this,'多个被邀请回答人请用空格分隔');"/>       							
       							</td>
       							<td align="left">
       								<input type=button value='地址簿' name='ANSWERBODY_Btn' class='Btn_s_a' onclick="multi_book('false','false','false','false','false','','','','','','INVITEDMAN');" border='0'>
       							</td>
       						</tr>
       					</table>                       
       				</td>                         
        ...
        <div class="ask_main" id="answer_commit_content">  
             <s:textarea  name='answer.acontent' id='ACONTENT' value="请填写您的回答" cssStyle="height:55px; width:630px; border:2px solid #056ea4; padding:10px; color:#d1d1d1" rows="5" cols="120" onblur="getInfo(this);" onfocus="setInfo(this);" cssClass="{string:true,required:true}"/>
              ...
              <tr>
              	<td align="right" style="padding-right:20px;" >
              		<div style="margin-top:7px; margin-bottom:8px;">
              			...
              			&nbsp;&nbsp;<span style="color:#bbbbbb;">赞</span>
			   		 	...
			   		 	&nbsp;&nbsp;<span id="holdout_span_<s:property value='aid'/>">
			   		 	   				<span class="holdout_span_c1" onclick="holdout(<s:property value='aid'/>);">赞</span>
			   		 	   			</span>
			   		 	   			<span style="color:red;" id="holdout_num_<s:property value='aid'/>">[<s:property value='holdout'/>]</span>
			   		 	</s:else>             			
              			&nbsp;&nbsp;<span id="talk_span_<s:property value='aid'/>"><span class="holdout_span_c1" onclick="talkopen(<s:property value='aid'/>);">评论</span></span>
              	 ...
              	 <form id="talkForm<s:property value='aid'/>" action="know_talk_save.action" method="post">
              		<div class="comment" id="comment_div_<s:property value='aid'/>" style="display:none;" >   <!-- style="display:none;"要控制 -->
              			...
              			<div id="comment_content_<s:property value='aid'/>" style="text-align:left;margin-bottom:5px;">
              			    <textarea class="{string:true,required:true}" name="talk.talkcontent" id="talkcontent_<s:property value='aid'/>" style="width:600px;" rows="3"></textarea>
              			</div>
			   		 		...
			   		 		<td align="left" style="padding-left:20px;" >
			   		 			...
			   		 			<s:if test="loginuid==auid && qtype==0 && atype==0">
			   		 				...
			   		 				<span style="margin-left:5px;">
			   		 					<span class="holdout_span_c1" onClick="editAnswer(<s:property value='aid'/>,<s:property value='qid'/>);">修改回答</span>
			   		 				</span>&nbsp;&nbsp;&nbsp;&nbsp;
			   		 				<img src="/iwork_img/know/delete_anwser.jpg"/>
			   		 				<span style="margin-left:5px;">
			   		 					<span class="holdout_span_c1" onClick="deleteAnswer(<s:property value='aid'/>,<s:property value='delNum'/>);">删除回答</span>
			   		 				</span>&nbsp;&nbsp;&nbsp;&nbsp;
			   		 			</s:if>
			   		 			<s:elseif test="isAdmin=='true' && qtype==0 && atype==0">	
			   		 				<img src="/iwork_img/know/delete_anwser.jpg"/>
			   		 				<span style="margin-left:5px;">
			   		 					<span class="holdout_span_c1" onClick="deleteAnswer(<s:property value='aid'/>,1);">删除回答</span>
			   		 				</span>&nbsp;&nbsp;&nbsp;&nbsp;
			   		 			</s:elseif>
			   		 			<s:if test="loginuid==auid && qtype==0 && atype==0">
			   		 				<img src="/iwork_img/know/set_best.jpg"/>
			   		 				<span style="margin-left:5px;">
			   		 					<span class="holdout_span_c1" onClick="setBestAnswer(<s:property value='aid'/>);">选为最佳回答 </span>
			   		 				</span>
			   		 			</s:if>
			   		 			 </div>
			   		 	   </td>
			   		 	   <td align="right" style="padding-right:20px;" >
			   		 	   		<div style="margin-top:7px; margin-bottom:8px;">回答者：
			   		 	   			...
			   		 	   			&nbsp;&nbsp;<span id="talk_span_<s:property value='aid'/>">
			   		 	   							<span class="holdout_span_c1" onclick="talkopen(<s:property value='aid'/>);">评论</span>
			   		 	   						</span>
			   		 	   						<span style="color:red;" id="talk_num_<s:property value='aid'/>">(<s:property value='talkcount'/>)</span>	
			   		 	   		</div>
			   		 	   	</td>
