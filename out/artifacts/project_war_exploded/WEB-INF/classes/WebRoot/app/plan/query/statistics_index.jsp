...
<link rel="stylesheet" type="text/css" href="iwork_css/common.css">
	...
	var selectedNodes;
		...
		function query(){
			...
			if(lx=="XHRC"){
				var pageUrl="plan_statistics_xhrc.action?year="+nd+"&month="+yf+"&bblx="+lx;
				window.location.href = pageUrl;
			}else if(lx=="QTHT"){
				var pageUrl="plan_statistics_qtht.action?year="+nd+"&month="+yf+"&bblx="+lx;
				window.location.href = pageUrl;
			}else if(lx=="BMFY"){
				var pageUrl="plan_statistics_bmfy.action?year="+nd+"&month="+yf+"&bblx="+lx;
				window.location.href = pageUrl;
			}else if(lx=="XHHT"){
				var pageUrl="plan_statistics_xhht.action?year="+nd+"&month="+yf+"&bblx="+lx;
				window.location.href = pageUrl;
			}else{
			 	var pageUrl="plan_statistics_xhrc.action?year="+nd+"&month="+yf+"&bblx="+lx;
				window.location.href = pageUrl;
