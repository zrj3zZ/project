...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>     		
	...
	var selectedNodes;
		...
		function changeView(){			
			...
			var kzbh = ${yskzbh};
			if(type!="project"){
				window.location.href="kjc_loadA5AuditIndex_action.action?yskzbh="+kzbh+"&viewType=project";
			}else{
				window.location.href="kjc_loadA5AuditIndex_action.action?yskzbh="+kzbh;
			}									
		}
