...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>     		
	...
	//var selectedNodes;
		...
		function add(){
			...
			var pageUrl = "showProjectDictory.action?instanceid="+instanceid;
		...
		function audit(){
			...
			var checkeds_BBZT = $("input[id*='BBZT']");
			var flag = false;
			for(var i=0;i<checkeds_BBZT.length;i++){
				if(checkeds_BBZT[i].value=="A1"){									
					flag = true;					
				}
			}
			if(!flag){
	...
	<div >
		<div class="tools_nav">
			...
			<table width="100%">
				<TR>
					...
					<td><s:if test="mainData.YDGLSTATUS==mainData.BBGL_QDBB">
		...
		<table WIDTH="100%" style="border:1px solid #efefef">
			...
			<s:iterator value="children"  id="inner" >
				...
				<input type='hidden' name='BBZT' id='BBZT' value='<s:property value="#inner.BBZT"/>' >
			</TR>
			</s:iterator>
			</s:iterator>
		</table>
