...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>
	...
	var selectedNodes;
		...
		function bohui(id){
			...
			var pageUrl = "sanbu_plan_xhrc_openA2Opinion.action?instanceid="+instanceid+"&id="+id;
		...
		function setValue(id,obj){
			...
			var num = byys;
			var instanceid = $("#instanceid").val();
			var pageUrl="sanbu_plan_xhrc_updateA2Byys.action";
		...
		function setfkly(id,obj){
			...
			var pageUrl="sanbu_plan_xhrc_updateA2Fkly.action";
		...
		function submit(){
			...
			var pageUrl="sanbu_plan_xhrc_auditA2.action?instanceid="+instanceid+"&ids="+ids.join(',');
		...
		function zjsubmit(){
			...
			var pageUrl="sanbu_plan_xhrc_tjsp.action?instanceid="+instanceid+"&ids="+ids.join(',');
			$.post(pageUrl,{},function(data){
	       		 if(data=='success'){
		             window.location.reload();
		         }else{
