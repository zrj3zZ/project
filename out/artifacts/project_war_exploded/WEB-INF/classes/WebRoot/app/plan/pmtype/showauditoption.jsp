		...
		<div class="tools_nav">
				...
				<table WIDTH="100%" style="border:1px solid #efefef">
					<TR  class="header">
						...
						<TD style="width:100px">审核节点名称</TD>
						<TD style="width:100px">人员</TD>
						<TD style="width:90px">动作</TD>
						<TD style="width:90px">审核意见</TD>
						<td style="width:80px">日期</TD>
					</TR>
				<s:iterator value="list"  status="status">
					<TR class="cell">		
						<TD style="text-align:center"><s:property value="#status.count"/></TD>						
						<td><s:property value="SHJD"/></td>
						<TD><s:property value="SHR"/></TD>
						<TD><s:property value="SHDZ"/></TD>				
						<TD><s:property value="CLYJ"/></TD>
						<TD><s:property value="SHSJ"/></TD>
					</TR>
				</s:iterator>
				</table>
			</div>
