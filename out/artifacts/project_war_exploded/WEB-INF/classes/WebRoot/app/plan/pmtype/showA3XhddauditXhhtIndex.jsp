		...
		<div class="tools_nav">
		 ...
		 <div >
		 	<table width="90%" style="margin:auto">
		 		...
		 		<!--  
		 		<tr>
		 			<td  class="td_title" >项目年度成本指标</td>
		 			<td  class="td_data" >
		 				
		 			</td>
		 			<td class="td_title">项目实际到款</td>
		 			<td class="td_data" ></td>
		 			<td class="td_title">截止上月底累计执行额</td>
		 			<td class="td_data" ></td>
		 			<td class="td_title">项目余额:</td>
		 			<td class="td_data" ></td>
		 			<td class="td_title">项目可用额度</td>
		 			<td class="td_data" ></td>
		 			<td class="td_title">本月预算总计</td>
		 			<td class="td_data" id="subNumTd"><s:property value="sumNum"/></td>
		 			<td class="td_title">日常费用预算</td>
		 			<td class="td_data" ></td>
		 		</tr>
		 		-->
		 	</table>
	...
	<div style="overflow:auto">
		...
		<table WIDTH="100%" style="border:1px solid #efefef">
			...
			<s:iterator value="children"  id="inner" >
				...
				<s:else>
					<TD ></TD>
				</s:else><TD ><a  href="javascript:showAuditInfo(<s:property value="#inner.INSTANCEID"/>,<s:property value="#inner.id"/>)">查看</a></TD>
