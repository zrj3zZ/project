...
<script type="text/javascript" src="iwork_plugs/artDialog/plugins/iframeTools.js"></script>     		
	...
	var selectedNodes;
		...
		function doExcute(instanceid){
			var pageUrl = "sanbu_plan_xhrc_showAuditIndex.action?instanceid="+instanceid;
			art.dialog.open(pageUrl,{
						id:'Category_show', 
						cover:true,
						title:'型号日常预算审核',
...
<!-- TOP区 -->
	...
	<div region="center" style="padding:10px;border:0px;">
		<table WIDTH="100%">
			...
			<s:iterator value="list1"  status="status">
				<TR class="cell">
				...
				<s:iterator value="children" id="inner"> 
						...
						<TD><s:property value="#inner.pass"/></TD>
						<TD><s:property value="#inner.note"/></TD>	
   						 </TR>
   				</s:iterator> 
