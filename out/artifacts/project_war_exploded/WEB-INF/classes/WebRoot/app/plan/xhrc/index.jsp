...
<link rel="stylesheet" type="text/css" href="iwork_css/common.css">
	...
	var selectedNodes;
		...
		function doExcute(instanceid){
			var pageUrl = "sanbu_plan_xhrc_showIndex.action?instanceid="+instanceid;
			art.dialog.open(pageUrl,{
						id:'Category_show', 
						cover:true,
						title:'型号日常预算编报',
	...
	<div region="center" style="padding:10px;border:0px;">
		<table WIDTH="100%">
			...
			<s:iterator value="list"  status="status">
				...
				<TD><a href="javascript:doExcute_xhht(<s:property value="INSTANCEID"/>)">型号合同编报</a></TD>
				<TD><a href="javascript:doExcute(<s:property value="INSTANCEID"/>)">型号日常编报</a></TD>
				<TD><a href="javascript:doExcute_oc(<s:property value="INSTANCEID"/>)">其他合同</a></TD>
			</TR>
			</s:iterator>
		</table>
	</div>
