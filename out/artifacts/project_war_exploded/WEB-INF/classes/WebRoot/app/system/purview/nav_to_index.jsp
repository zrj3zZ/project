...
<title>IWORK综合应用管理系统</title> 
 ...
 //==========================装载快捷键===============================//快捷键
			...
			var setting2 = {
					...
					async: {
						enable: true, 
						url:"openUnNavPurviewList.action",
						dataType:"json", 
						autoParam:["id","type"]
					},callback: { 
		...
		function onAsyncError(event, treeId, treeNode, XMLHttpRequest, textStatus, errorThrown) {
 		...
 		function onClick(event, treeId, treeNode, clickFlag){
 			...
 			var type = treeNode.nodeType;
	 			...
	 			var url = "openUnNavPurviewList.action?navType="+type+"&navId="+treeNode.id;
				var setting2 = {
					check: {
						enable: true
					},
			...
			if(type=='category'){
				...
				function setpurview(){
					...
					var zTree = $.fn.zTree.getZTreeObj("purviewListTree");
		 			...
		 			$("#purviewIds").val(str);
					$.post('openPurviewNav_setNavlist.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){
...
<!-- TOP区 -->
	...
	<s:form name="editForm" id="editForm" theme="simple">
		 ...
		 <s:hidden name="navId" id="navId"/>
		 <s:hidden name="navType" id="navType"/>
</s:form>
	</div>
