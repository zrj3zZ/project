		 ...
		 //==========================装载快捷键===============================//快捷键
				...
				$(document).ready(function(){
					var setting = {
							...
							async: {
								enable: true,  
								url:"openPurviewDemtreejson.action?purviewid=<s:property value='purviewid'/>",
								dataType:"json",  
								dataFilter: filter,
								autoParam:["id","type"]
							},callback: {
				...
				function setpurview(){
					asyncObjs();
					$.post('openPurviewDem_setpurview.action',$("#editForm").serialize(),function(data){
				    	if(data=='success'){ 
...
<s:form name="editForm" id="editForm" action="openPurviewDem_setpurview" theme="simple" >
		 <s:hidden name="purviewid" />
		 <s:hidden name="demIds" id="demIds" />
</s:form>
</div>
