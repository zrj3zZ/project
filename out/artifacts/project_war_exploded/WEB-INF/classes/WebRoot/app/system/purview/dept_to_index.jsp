...
<title>IWORK综合应用管理系统</title> 
 ...
 //==========================装载快捷键===============================//快捷键
			...
			var setting = {
					...
					async: {
						enable: true, 
						url:encodeURI("openPurviewDept_treejson.action?companyid=<s:property value="companyid"/>&companyname=<s:property value="companyname"/>"),
						dataType:"json", 
...
<!-- TOP区 -->
	<div region="north" border="false" style="height:40px;border-bottom:1px;">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	      <tr>
          	<td align="left"><span id="title_span" style='font-size:14px;font-family:黑体'><img alt="部门-->权限组授权" src="iwork_img/shield.png" border="0"/>部门-->权限组授权</span></td>
	...
	<table style="height:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <a href="" onClick="unExpandAll();return false;"><strong  style='color:#990033'>全部折叠</strong></a>
			...
			<fieldset style="width:150px;margin-left:5px;padding:5px;">
								...
								<legend >功能提示</legend>
								 【说明】选定的授权部门,权限范围仅作用于直接隶属与该部门下的员工,子部门权限需要分别授予。<br><br>
							</fieldset>
