...
<html>
  <head>  
	...
	function linkSub(id,pid){
	     var url = 'web_service_param_output.action?id='+id+'&pid='+pid;
		 this.location = url;
	}
	
	function add(){
	    var pid=$('#pid').val();
		var url = 'web_service_param_addPage.action?inorout=output&pid='+pid;
		openDialog('添加',url);
	}
	//添加和编辑窗口
  ...
  <body class="easyui-layout">
     ...
     <div region="center" style="padding:3px;border:0px;">					
					<div>
						<table id="condition_grid" style="height:400px"  iconCls="icon-edit" singleSelect="false" idField="ID" url="web_service_param_json.action?pid=<s:property value='id'  escapeHtml='false'/>&inorout=output" >
									<thead>
										<tr>
