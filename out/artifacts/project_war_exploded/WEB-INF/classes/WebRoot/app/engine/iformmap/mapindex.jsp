...
<body class="easyui-layout"> 
            ...
            <table width="100%" border="0" cellspacing="4" cellpadding="3">
			  <tr>
			    ...
			    <td class="form_data">
			    	<s:textfield name="model.fieldName" theme="simple" readonly="true" cssStyle="background:#efefef"></s:textfield>
			  </tr> 
			  <tr>
			 ...
			 <tr>
               ...
               <div id="menuContent" class="menuContent" style="display:none;background-color:#fff;border:1px solid #efefef; position: absolute;height:280px;width:250px;overflow:auto;"> 
                ...
                <a id="btnEp" class="easyui-linkbutton" icon="icon-back" href="javascript:doback();" >前一个</a> 
                <a id="btnEp" class="easyui-linkbutton" icon="icon-process-trans" href="javascript:doNext();" >后一个</a> 
