...
<title>IWORK综合应用管理系统</title> 
	...
	<script type="text/javascript" src="iwork_js/engine/dem_index.js" ></script> 	
	    ...
	    function enterKey(){
	     ...
	     function doSearch(){ 
					  ...
					  $("#searchkey").val(searchTxt); 
					  	var url = encodeURI("sysDem_doSearch.action?searchkey?searchkey="+searchTxt+"&showtype="+status);
...
<!-- TOP区 -->
	<div region="north" border="false" style="padding:0px;overflow:no;scrolling:no;border-bottom:1px;">
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<a href="javascript:addDem();" class="easyui-linkbutton" plain="true" iconCls="icon-add">新增</a>
	...
	<div region="center" style="padding:3px;border:0px;">
			<iframe id="demListFrame" src="sysEngineDem_Help.action"  frameborder="no" border="0" marginwidth="0″ marginheight="0″ scrolling="auto" allowtransparency="yes"  id="metadataFrame" name="demListFrame" width="100%" height="100%"></iframe>
