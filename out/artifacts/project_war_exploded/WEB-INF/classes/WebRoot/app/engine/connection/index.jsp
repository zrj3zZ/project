...
<title>IWORK综合应用管理系统</title>
	...
	<script type="text/javascript" src="iwork_js/engine/conn_index.js" ></script>	 
...
<!-- TOP区 -->
	...
	<div region="center" style="padding:3px;border:0px;">
			<iframe id="connListFrame" name="connListFrame" frameborder="no" border="0" marginwidth="0″ marginheight="0″ scrolling="auto" allowtransparency="yes"  id="metadataFrame" name="metadataFrame" width="100%" height="100%"></iframe>
