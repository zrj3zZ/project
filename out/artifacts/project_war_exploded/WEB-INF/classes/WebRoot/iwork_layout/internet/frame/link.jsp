...
<link rel="stylesheet" type="text/css" href="iwork_css/jquerycss/icon.css">
	...
	<script type="text/javascript" src="iwork_layout/skins2014/js/all.js"></script>
   s <script type="text/javascript" src="iwork_js/lhgdialog/lhgdialog.min.js?skin=default"></script> 