...
@XmlType(name = "CompositeType", propOrder = { "boolValue", "stringValue" })
public class CompositeType {

	@XmlElement(name = "BoolValue")
	protected Boolean boolValue;
	@XmlElementRef(name = "StringValue", namespace = "http://schemas.datacontract.org/2004/07/SMSWcfService", type = JAXBElement.class)
