 ...
 * 
 */
public class zqbDzwthProLuyouJumpSbzlEvent extends SysJumpTriggerEvent {
	public zqbDzwthProLuyouJumpSbzlEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzsbzlLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlDzsbzlLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlDzsbzlLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlDzsbzlLcConf.getJd3();
		}else{
			return SystemConfig._hlDzsbzlLcConf.getJd4();
		}
	}
