...
public class zqbBgProLuyouJumpCzyjEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpCzyjEvent(UserContext me, Task task) {
		super(me, task);
	}
	/**
	 * 获得下一个办理节点
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgCzyjLcConf.getJd1())){
			return SystemConfig._hlBgCzyjLcConf.getJd2();
		}else{
			return SystemConfig._hlBgCzyjLcConf.getJd3();
		}
	}
