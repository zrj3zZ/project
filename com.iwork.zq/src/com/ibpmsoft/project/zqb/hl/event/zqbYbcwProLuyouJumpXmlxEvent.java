...
public class zqbYbcwProLuyouJumpXmlxEvent extends SysJumpTriggerEvent{

	public zqbYbcwProLuyouJumpXmlxEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlYbcwxmlxLcConf.getJd1())){
			return SystemConfig._hlYbcwxmlxLcConf.getJd2();
		}else{
			return SystemConfig._hlYbcwxmlxLcConf.getJd3();
		}
	}
