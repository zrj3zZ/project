 ...
 * 
 */
public class zqbSgProLuyouJumpFkwtEvent extends SysJumpTriggerEvent {
	public zqbSgProLuyouJumpFkwtEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlSgfkwtLcConf.getJd1())){
			return SystemConfig._hlSgfkwtLcConf.getJd2();
		}else{
			return SystemConfig._hlSgfkwtLcConf.getJd3();
		}
	}
