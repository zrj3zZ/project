...
public class zqbDzwothProLuyouJumpFkhfEvent extends SysJumpTriggerEvent{

	public zqbDzwothProLuyouJumpFkhfEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd1())){
			return SystemConfig._hlDzwfkhfLcConf.getJd2();
		}else{
			return SystemConfig._hlDzwfkhfLcConf.getJd3();
		}
	}
