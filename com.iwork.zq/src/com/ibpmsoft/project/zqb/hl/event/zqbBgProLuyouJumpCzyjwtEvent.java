...
public class zqbBgProLuyouJumpCzyjwtEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpCzyjwtEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgCzyjwtLcConf.getJd1())){
			return SystemConfig._hlBgCzyjwtLcConf.getJd2();
		}else{
			return SystemConfig._hlBgCzyjwtLcConf.getJd3();
		}
	}
