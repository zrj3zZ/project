 ...
 * 
 */
public class zqbGpProLuyouJumpGzfkEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpGzfkEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpgzfkLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpgzfkLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpgzfkLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpgzfkLcConf.getJd3();
		}else{
			return SystemConfig._hlGpgzfkLcConf.getJd4();
		}
	}
