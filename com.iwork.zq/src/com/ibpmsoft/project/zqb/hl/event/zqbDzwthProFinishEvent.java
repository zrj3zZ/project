 ...
 *
 */
public class zqbDzwthProFinishEvent extends ProcessTriggerEvent {
	public zqbDzwthProFinishEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(flag){
				...
				String content = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.DZWTH_END_KEY, contentMap);
