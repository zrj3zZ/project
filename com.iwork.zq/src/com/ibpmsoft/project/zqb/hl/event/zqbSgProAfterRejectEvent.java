 ...
 *
 */
public class zqbSgProAfterRejectEvent extends ProcessStepTriggerEvent {

	public zqbSgProAfterRejectEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(flag){
				...
				String content = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.SG_REJECT_KEY, contentMap);
				if (target != null) {
					if (!content.equals("")) {
						//发送短信
