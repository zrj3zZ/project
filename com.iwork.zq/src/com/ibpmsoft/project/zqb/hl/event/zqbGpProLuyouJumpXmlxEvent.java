 ...
 * 
 */
public class zqbGpProLuyouJumpXmlxEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpXmlxEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpxmlxLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpxmlxLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpxmlxLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpxmlxLcConf.getJd3();
		}else{
			return SystemConfig._hlGpxmlxLcConf.getJd4();
		}
	}
