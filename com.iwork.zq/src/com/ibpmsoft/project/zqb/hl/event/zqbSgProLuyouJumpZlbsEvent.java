 ...
 * 
 */
public class zqbSgProLuyouJumpZlbsEvent extends SysJumpTriggerEvent {
	public zqbSgProLuyouJumpZlbsEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlSgzlbsLcConf.getJd1())){
			return SystemConfig._hlSgzlbsLcConf.getJd2();
		}else{
			return SystemConfig._hlSgzlbsLcConf.getJd3();
		}
	}
