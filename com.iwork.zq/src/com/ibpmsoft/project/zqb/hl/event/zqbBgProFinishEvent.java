...
public class zqbBgProFinishEvent extends ProcessTriggerEvent{

	public zqbBgProFinishEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(flag){
				...
				String content = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.BG_END_KEY, contentMap);
