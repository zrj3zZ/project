...
public class zqbYbcwProLuyouJumpCwgzjdEvent extends SysJumpTriggerEvent {

	public zqbYbcwProLuyouJumpCwgzjdEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlYbcwCwgzjdLcConf.getJd1())){
			return SystemConfig._hlYbcwCwgzjdLcConf.getJd2();
		}else{
			return SystemConfig._hlYbcwCwgzjdLcConf.getJd3();
		}
	}
	...
	public List<UserContext> getNextUserList() {
		...
		String manager = DBUtil.getDataStr("MANAGER", "SELECT SUBSTR(B.MANAGER,0,INSTR(B.MANAGER,'[',1)-1) AS MANAGER FROM BD_ZQB_ZBSP B WHERE B.XMBH=?", params);
