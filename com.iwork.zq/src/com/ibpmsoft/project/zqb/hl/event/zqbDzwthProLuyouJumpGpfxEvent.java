 ...
 * 
 */
public class zqbDzwthProLuyouJumpGpfxEvent extends SysJumpTriggerEvent {
	public zqbDzwthProLuyouJumpGpfxEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzgpfxLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlDzgpfxLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlDzgpfxLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlDzgpfxLcConf.getJd3();
		}else{
			return SystemConfig._hlDzgpfxLcConf.getJd4();
		}
	}
