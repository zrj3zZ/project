...
public class zqbBgProAfterRejectEvent extends ProcessStepTriggerEvent{

	public zqbBgProAfterRejectEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(flag){
				...
				String content = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.BG_REJECT_KEY, contentMap);
				if (target != null) {
					if (!content.equals("")) {
						//发送短信
