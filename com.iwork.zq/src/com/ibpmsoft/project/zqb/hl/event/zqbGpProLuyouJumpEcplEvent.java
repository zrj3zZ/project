 ...
 * 
 */
public class zqbGpProLuyouJumpEcplEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpEcplEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpecplLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpecplLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpecplLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpecplLcConf.getJd3();
		}else{
			return SystemConfig._hlGpecplLcConf.getJd4();
		}
	}
