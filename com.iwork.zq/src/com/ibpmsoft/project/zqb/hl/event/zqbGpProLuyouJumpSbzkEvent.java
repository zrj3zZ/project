 ...
 * 
 */
public class zqbGpProLuyouJumpSbzkEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpSbzkEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpsbzkLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpsbzkLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpsbzkLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpsbzkLcConf.getJd3();
		}else{
			return SystemConfig._hlGpsbzkLcConf.getJd4();
		}
	}
