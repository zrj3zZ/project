...
public class zqbBgProLuyouJumpCzyjhfEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpCzyjhfEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgCzyjhfLcConf.getJd1())){
			return SystemConfig._hlBgCzyjhfLcConf.getJd2();
		}else{
			return SystemConfig._hlBgCzyjhfLcConf.getJd3();
		}
	}
