 ...
 * 
 */
public class zqbDzwthProLuyouJumpYjgwEvent extends SysJumpTriggerEvent {
	public zqbDzwthProLuyouJumpYjgwEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzyjgwLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlDzyjgwLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlDzyjgwLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlDzyjgwLcConf.getJd3();
		}else{
			return SystemConfig._hlDzyjgwLcConf.getJd4();
		}
	}
