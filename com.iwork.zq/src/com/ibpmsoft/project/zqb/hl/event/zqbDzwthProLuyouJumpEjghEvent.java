 ...
 * 
 */
public class zqbDzwthProLuyouJumpEjghEvent extends SysJumpTriggerEvent {
	public zqbDzwthProLuyouJumpEjghEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzejghLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlDzejghLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlDzejghLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlDzejghLcConf.getJd3();
		}else{
			return SystemConfig._hlDzejghLcConf.getJd4();
		}
	}
