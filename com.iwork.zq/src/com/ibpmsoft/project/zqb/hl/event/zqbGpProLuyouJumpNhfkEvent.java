 ...
 * 
 */
public class zqbGpProLuyouJumpNhfkEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpNhfkEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpnhfkLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpnhfkLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpnhfkLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpnhfkLcConf.getJd3();
		}else{
			return SystemConfig._hlGpnhfkLcConf.getJd4();
		}
	}
