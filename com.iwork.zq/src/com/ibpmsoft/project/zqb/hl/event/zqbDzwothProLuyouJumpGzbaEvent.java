...
public class zqbDzwothProLuyouJumpGzbaEvent extends SysJumpTriggerEvent{
	
	public zqbDzwothProLuyouJumpGzbaEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd1())){
			return SystemConfig._hlDzwgzbaLcConf.getJd2();
		}else{
			return SystemConfig._hlDzwgzbaLcConf.getJd3();
		}
	}
