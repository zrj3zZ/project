...
public class zqbBgProAfterCommitEvent extends ProcessStepTriggerEvent{

	public zqbBgProAfterCommitEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(flag){
				...
				String content = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.BG_COMMIT_KEY, contentMap);
				...
				if (target != null) {
					if (!content.equals("")) {
						...
						if (email != null && !email.equals("")) {
							...
							MessageAPI.getInstance().sendSysMail(senduser, email, "重组项目流程审核", content.toString());
						}
					}
				}
