...
public class zqbDzwothProLuyouJumpSbnhEvent extends SysJumpTriggerEvent{

	public zqbDzwothProLuyouJumpSbnhEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd1())){
			return SystemConfig._hlDzwsbnhLcConf.getJd2();
		}else{
			return SystemConfig._hlDzwsbnhLcConf.getJd3();
		}
	}
