...
public class zqbBgProLuyouJumpXmlxEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpXmlxEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgxmlxLcConf.getJd1())){
			return SystemConfig._hlBgxmlxLcConf.getJd2();
		}else{
			return SystemConfig._hlBgxmlxLcConf.getJd3();
		}
	}
