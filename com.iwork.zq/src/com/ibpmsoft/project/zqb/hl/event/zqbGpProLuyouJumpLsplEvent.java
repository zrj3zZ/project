 ...
 * 
 */
public class zqbGpProLuyouJumpLsplEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpLsplEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGplsplLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGplsplLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGplsplLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGplsplLcConf.getJd3();
		}else{
			return SystemConfig._hlGplsplLcConf.getJd4();
		}
	}
