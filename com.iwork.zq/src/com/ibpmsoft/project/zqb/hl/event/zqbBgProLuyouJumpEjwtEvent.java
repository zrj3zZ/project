...
public class zqbBgProLuyouJumpEjwtEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpEjwtEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgEjwtLcConf.getJd1())){
			return SystemConfig._hlBgEjwtLcConf.getJd2();
		}else{
			return SystemConfig._hlBgEjwtLcConf.getJd3();
		}
	}
