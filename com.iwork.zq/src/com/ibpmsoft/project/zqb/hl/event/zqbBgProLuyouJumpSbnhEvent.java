...
public class zqbBgProLuyouJumpSbnhEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpSbnhEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgSbnhLcConf.getJd1())){
			return SystemConfig._hlBgSbnhLcConf.getJd2();
		}else{
			return SystemConfig._hlBgSbnhLcConf.getJd3();
		}
	}
