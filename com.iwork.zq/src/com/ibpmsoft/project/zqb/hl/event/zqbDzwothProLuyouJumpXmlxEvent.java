...
public class zqbDzwothProLuyouJumpXmlxEvent extends SysJumpTriggerEvent{

	public zqbDzwothProLuyouJumpXmlxEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd1())){
			return SystemConfig._hlDzwxmlxLcConf.getJd2();
		}else{
			return SystemConfig._hlDzwxmlxLcConf.getJd3();
		}
	}
