...
public class zqbBgProLuyouJumpEjhfEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpEjhfEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgEjhfLcConf.getJd1())){
			return SystemConfig._hlBgEjhfLcConf.getJd2();
		}else{
			return SystemConfig._hlBgEjhfLcConf.getJd3();
		}
	}
