...
public class zqbBgDemAfterSaveEvent extends DemTriggerEvent  {
	public zqbBgDemAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	
	public boolean execute() {
		//定增(200人以内)项目
		String XMUUID=DBUtil.getString("SELECT UUID FROM SYS_DEM_ENGINE WHERE TITLE='重组项目管理'", "UUID");
