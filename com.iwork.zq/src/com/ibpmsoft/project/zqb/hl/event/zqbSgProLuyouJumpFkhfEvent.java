 ...
 * 
 */
public class zqbSgProLuyouJumpFkhfEvent extends SysJumpTriggerEvent {
	public zqbSgProLuyouJumpFkhfEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlSgfkhfLcConf.getJd1())){
			return SystemConfig._hlSgfkhfLcConf.getJd2();
		}else{
			return SystemConfig._hlSgfkhfLcConf.getJd3();
		}
	}
