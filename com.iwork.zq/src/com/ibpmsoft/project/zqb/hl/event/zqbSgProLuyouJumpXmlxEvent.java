 ...
 * 
 */
public class zqbSgProLuyouJumpXmlxEvent extends SysJumpTriggerEvent {
	public zqbSgProLuyouJumpXmlxEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlSgxmlxLcConf.getJd1())){
			return SystemConfig._hlSgxmlxLcConf.getJd2();
		}else{
			return SystemConfig._hlSgxmlxLcConf.getJd3();
		}
	}
