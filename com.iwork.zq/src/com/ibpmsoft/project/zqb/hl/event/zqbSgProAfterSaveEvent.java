 ...
 * 
 */
public class zqbSgProAfterSaveEvent extends ProcessStepTriggerEvent {
	private static Logger logger = Logger.getLogger(zqbSgProAfterSaveEvent.class);
	private final static String CN_FILENAME = "/common.properties";

	public zqbSgProAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
