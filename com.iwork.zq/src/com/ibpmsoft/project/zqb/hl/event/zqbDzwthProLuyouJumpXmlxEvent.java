 ...
 * 
 */
public class zqbDzwthProLuyouJumpXmlxEvent extends SysJumpTriggerEvent {
	public zqbDzwthProLuyouJumpXmlxEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlDzxmlxLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlDzxmlxLcConf.getJd3();
		}else{
			return SystemConfig._hlDzxmlxLcConf.getJd4();
		}
	}
