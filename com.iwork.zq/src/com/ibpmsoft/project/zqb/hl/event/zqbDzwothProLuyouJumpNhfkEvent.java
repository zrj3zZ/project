...
public class zqbDzwothProLuyouJumpNhfkEvent extends SysJumpTriggerEvent{

	public zqbDzwothProLuyouJumpNhfkEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzxmlxLcConf.getJd1())){
			return SystemConfig._hlDzwnhfkLcConf.getJd2();
		}else{
			return SystemConfig._hlDzwnhfkLcConf.getJd3();
		}
	}
