 ...
 * 
 */
public class zqbDzwthProLuyouJumpEjgwEvent extends SysJumpTriggerEvent {
	public zqbDzwthProLuyouJumpEjgwEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlDzejgwLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlDzejgwLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlDzejgwLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlDzejgwLcConf.getJd3();
		}else{
			return SystemConfig._hlDzejgwLcConf.getJd4();
		}
	}
