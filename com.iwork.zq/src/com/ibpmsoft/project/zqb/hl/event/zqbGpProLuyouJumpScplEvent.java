 ...
 * 
 */
public class zqbGpProLuyouJumpScplEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpScplEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpscplLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpscplLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpscplLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpscplLcConf.getJd3();
		}else{
			return SystemConfig._hlGpscplLcConf.getJd4();
		}
	}
