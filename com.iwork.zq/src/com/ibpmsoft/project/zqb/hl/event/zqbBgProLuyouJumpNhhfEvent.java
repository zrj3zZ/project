...
public class zqbBgProLuyouJumpNhhfEvent extends SysJumpTriggerEvent{

	public zqbBgProLuyouJumpNhhfEvent(UserContext me, Task task) {
		super(me, task);
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlBgNhhfLcConf.getJd1())){
			return SystemConfig._hlBgNhhfLcConf.getJd2();
		}else{
			return SystemConfig._hlBgNhhfLcConf.getJd3();
		}
	}
