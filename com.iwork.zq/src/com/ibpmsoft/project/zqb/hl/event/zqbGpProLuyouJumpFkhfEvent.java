 ...
 * 
 */
public class zqbGpProLuyouJumpFkhfEvent extends SysJumpTriggerEvent {
	public zqbGpProLuyouJumpFkhfEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._hlGpfkhfLcConf.getJd1())&&manager != null && !manager.toString().equals("")){
			return SystemConfig._hlGpfkhfLcConf.getJd2();
		}else if(actStepId.equals(SystemConfig._hlGpfkhfLcConf.getJd2())&&owner != null && !owner.toString().equals("")){
			return SystemConfig._hlGpfkhfLcConf.getJd3();
		}else{
			return SystemConfig._hlGpfkhfLcConf.getJd4();
		}
	}
