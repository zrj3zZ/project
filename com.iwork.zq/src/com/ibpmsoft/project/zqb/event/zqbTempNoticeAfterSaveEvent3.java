 ...
 *
 */
public class zqbTempNoticeAfterSaveEvent3 extends ProcessStepTriggerEvent {
	...
	public zqbTempNoticeAfterSaveEvent3(UserContext uc, HashMap hash) {
		super(uc, hash);
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			/*String useraddress3 = ZQBNoticeUtil.getInstance().getZZCustomer(customerno);
			String userid = UserContextUtil.getInstance().getUserId(useraddress3);*/
