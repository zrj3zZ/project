 ...
 * 
 */
public class ShanXiZqbBgSbzlAfterSaveEvent extends ProcessStepTriggerEvent {

	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbBgSbzlAfterSaveEvent.class);
	public ShanXiZqbBgSbzlAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
