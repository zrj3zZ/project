 ...
 * 
 */
public class zqbLuyouJumpZYDDThreeEvent extends SysJumpTriggerEvent {

	public zqbLuyouJumpZYDDThreeEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public List<UserContext> getNextUserList() {
		...
		if (map!=null&&map.size() > 0 ) {
			...
			if (hash.get("WLINS") != null
				...
				// 有参与人取得第三个参与人员
				if (list.size() > 2) {
					if (list.get(2).get("USERID") != null) {
						String userid = list.get(2).get("USERID").toString();
