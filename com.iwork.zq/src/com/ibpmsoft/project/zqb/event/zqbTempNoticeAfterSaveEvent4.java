 ...
 *
 */
public class zqbTempNoticeAfterSaveEvent4 extends ProcessStepTriggerEvent {
	...
	public zqbTempNoticeAfterSaveEvent4(UserContext uc, HashMap hash) {
		super(uc, hash);
...
//			smsContent = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.ANN_ADD_KEY, map);
			...
			/*String useraddress4 = ZQBNoticeUtil.getInstance().getZKCustomer(customerno);
			String userid = UserContextUtil.getInstance().getUserId(useraddress4);*/
