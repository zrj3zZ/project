 ...
 *
 */
public class zqbDGDYAfterSaveEventtwo extends ProcessStepTriggerEvent {

	private static final String CN_FILENAME = "/common.properties"; //抓取网站配置文件     
	public zqbDGDYAfterSaveEventtwo(UserContext uc, HashMap hash) {
		super(uc, hash);
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			LogUtil.getInstance().addLog(lcDataId, "工作底稿调阅", "创建流程："+dataMap.get("DYZLNR").toString());
