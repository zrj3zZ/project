...
public class ShanXiZqbNhfkBhEvent extends ProcessStepTriggerEvent {
	
	public ShanXiZqbNhfkBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			LogUtil.getInstance().addLog(dataId, "内核反馈审核流程", customername+"内核反馈审核流程被驳回！");
