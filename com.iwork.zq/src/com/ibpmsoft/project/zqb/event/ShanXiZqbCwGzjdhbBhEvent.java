...
public class ShanXiZqbCwGzjdhbBhEvent extends ProcessStepTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbCwGzjdhbBhEvent.class);
	public ShanXiZqbCwGzjdhbBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			if(!dataMap2.isEmpty()){
				...
				LogUtil.getInstance().addLog(dataId, "一般财务工作进度汇报审核流程", smsContent);
