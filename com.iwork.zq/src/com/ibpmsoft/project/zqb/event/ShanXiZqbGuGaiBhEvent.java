...
public class ShanXiZqbGuGaiBhEvent extends ProcessStepTriggerEvent {
	
	public ShanXiZqbGuGaiBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			LogUtil.getInstance().addLog(dataId, "项目股改审核流程", ygsmc+"项目股改审核流程被驳回！");
