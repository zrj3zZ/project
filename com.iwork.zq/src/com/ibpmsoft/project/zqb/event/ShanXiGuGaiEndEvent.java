...
public class ShanXiGuGaiEndEvent extends ProcessTriggerEvent {
	public ShanXiGuGaiEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			content.append(dataMap.get("YGSMC").toString()).append("项目股改审核通过！");
