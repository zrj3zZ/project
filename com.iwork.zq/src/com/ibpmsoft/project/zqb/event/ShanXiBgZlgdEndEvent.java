...
public class ShanXiBgZlgdEndEvent extends ProcessTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiBgZlgdEndEvent.class);
	public ShanXiBgZlgdEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(!dataMap2.isEmpty()){
				...
				content.append(jyf).append("并购资料归档审核通过！");
