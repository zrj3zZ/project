 ...
 * 
 */
public class zqbLuyouJumpZYDDTwoEvent extends SysJumpTriggerEvent {

	public zqbLuyouJumpZYDDTwoEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public List<UserContext> getNextUserList() {
		...
		if (map!=null&&map.size() > 0 ) {
			...
			if (hash.get("WLINS") != null
				...
				// 有参与人取得第二个参与人员
				if (list.size() > 1) {
					if (list.get(1).get("USERID") != null) {
						String userid = list.get(1).get("USERID").toString();
