...
public class ShanXiZqbCwZlgdBhEvent extends ProcessStepTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbCwZlgdBhEvent.class);
	public ShanXiZqbCwZlgdBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			if(!dataMap2.isEmpty()){
				...
				LogUtil.getInstance().addLog(dataId, "一般财务资料归档审核流程", smsContent);
