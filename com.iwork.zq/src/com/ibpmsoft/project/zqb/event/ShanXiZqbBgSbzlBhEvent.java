...
public class ShanXiZqbBgSbzlBhEvent extends ProcessStepTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbBgSbzlBhEvent.class);
	public ShanXiZqbBgSbzlBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			if(!dataMap2.isEmpty()){
				...
				LogUtil.getInstance().addLog(dataId, "并购申报资料审核流程", smsContent);
