 ...
 * 
 */
public class ShanXiZqbCwXmlxAfterSaveEvent extends ProcessStepTriggerEvent {

	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbCwXmlxAfterSaveEvent.class);
	public ShanXiZqbCwXmlxAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
