 ...
 *
 */
public class zqbRcywcbAfterSaveEventThree extends ProcessStepTriggerEvent {

	private static final String CN_FILENAME = "/common.properties"; //抓取网站配置文件     
	public zqbRcywcbAfterSaveEventThree(UserContext uc, HashMap hash) {
		super(uc, hash);
	...
	public boolean execute() {
		...
		if(dataMap!=null){
            ...
            if(lcbsexists!=null&&lcbsexists.size()==1){
				...
				LogUtil.getInstance().addLog(dataId, "日常业务呈报管理", "添加公告："+value);
			}
	            String smsContent = "";
				String mailContent = "";
