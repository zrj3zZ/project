 ...
 *
 */
public class zqbTempNoticeAfterSaveEvent6 extends ProcessStepTriggerEvent {
	...
	public zqbTempNoticeAfterSaveEvent6(UserContext uc, HashMap hash) {
		super(uc, hash);
		...
		if(dataMap!=null){
         ...
         //   String smsContent = "";
        	...
        	//	smsContent = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.ANN_ADD_KEY, map); 
        		...
        		/*String useraddress6 = ZQBNoticeUtil.getInstance().getCYFZR2Customer(customerno);*/
        		String username = "";
        		...
        		/*String userid = UserContextUtil.getInstance().getUserId(useraddress6);*/
