 ...
 * 
 */
public class ZqbSXGpfxsjfxAfterSaveEvent extends ProcessStepTriggerEvent {

	public ZqbSXGpfxsjfxAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			String num = DBUtil.getDataStr("NUM", "SELECT COUNT(ID) NUM FROM BD_ZQB_GPFXXMSJFXB WHERE PROJECTNO=?",map);
