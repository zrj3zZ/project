...
public class ZqbSXGpfxsbzlEndEvent extends ProcessTriggerEvent {
	public ZqbSXGpfxsbzlEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			content.append("股票发行项目:").append(projectname).append(",申报资料信息已审批通过!");
