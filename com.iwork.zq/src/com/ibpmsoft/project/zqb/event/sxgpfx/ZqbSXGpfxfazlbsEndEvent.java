...
public class ZqbSXGpfxfazlbsEndEvent extends ProcessTriggerEvent {
	public ZqbSXGpfxfazlbsEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			content.append("股票发行项目:").append(projectname).append(",方案资料报审信息已审批通过!");
