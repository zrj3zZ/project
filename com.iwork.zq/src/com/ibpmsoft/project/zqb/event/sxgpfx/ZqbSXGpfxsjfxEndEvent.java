...
public class ZqbSXGpfxsjfxEndEvent extends ProcessTriggerEvent {
	public ZqbSXGpfxsjfxEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			content.append("股票发行项目:").append(projectname).append(",实际发行信息已审批通过!");
