 ...
 * 
 */
public class ZqbSXGpfxsbzlAfterSaveEvent extends ProcessStepTriggerEvent {

	public ZqbSXGpfxsbzlAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			String num = DBUtil.getDataStr("NUM", "SELECT COUNT(ID) NUM FROM BD_ZQB_GPFXXMSBZLSB WHERE PROJECTNO=?",map);
