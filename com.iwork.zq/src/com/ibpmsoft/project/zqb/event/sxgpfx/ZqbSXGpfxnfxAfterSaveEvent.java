 ...
 * 
 */
public class ZqbSXGpfxnfxAfterSaveEvent extends ProcessStepTriggerEvent {

	public ZqbSXGpfxnfxAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			String num = DBUtil.getDataStr("NUM", "SELECT COUNT(ID) NUM FROM BD_ZQB_GPFXXMNFXB WHERE PROJECTNO=?",map);
