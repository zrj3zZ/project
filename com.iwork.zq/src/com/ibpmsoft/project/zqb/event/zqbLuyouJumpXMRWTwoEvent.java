 ...
 * 
 */
public class zqbLuyouJumpXMRWTwoEvent extends SysJumpTriggerEvent {

	public zqbLuyouJumpXMRWTwoEvent(UserContext me, Task task) {
		super(me, task);
	}
