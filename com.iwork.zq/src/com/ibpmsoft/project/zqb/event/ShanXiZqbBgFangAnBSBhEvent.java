...
public class ShanXiZqbBgFangAnBSBhEvent extends ProcessStepTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbBgFangAnBSBhEvent.class);
	public ShanXiZqbBgFangAnBSBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			if(!dataMap2.isEmpty()){
				...
				LogUtil.getInstance().addLog(dataId, "并购方案资料报审审核流程", smsContent);
