 ...
 * 
 */
public class ShanXiZqbBgXmlxAfterSaveEvent extends ProcessStepTriggerEvent {

	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbBgXmlxAfterSaveEvent.class);
	public ShanXiZqbBgXmlxAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
