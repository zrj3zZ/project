 ...
 * 
 */
public class zqbLuyouJumpGpfxfpbmEvent2 extends SysJumpTriggerEvent {
	public zqbLuyouJumpGpfxfpbmEvent2(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		...
		if(actStepId.equals(SystemConfig._gpfxfpbmConf.getJd2())){
	...
	public List<UserContext> getNextUserList() {
		...
		if (alldata.get(0) != null && !alldata.get(0).get("USERNAME").toString().equals("")) {
