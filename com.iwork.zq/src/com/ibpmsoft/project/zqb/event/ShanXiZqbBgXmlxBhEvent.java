...
public class ShanXiZqbBgXmlxBhEvent extends ProcessStepTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbBgXmlxBhEvent.class);
	public ShanXiZqbBgXmlxBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			if(!dataMap2.isEmpty()){
				...
				LogUtil.getInstance().addLog(dataId, "并购项目立项审核流程", smsContent);
