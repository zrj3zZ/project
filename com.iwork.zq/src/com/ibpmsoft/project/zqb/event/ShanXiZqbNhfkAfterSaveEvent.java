 ...
 * 
 */
public class ShanXiZqbNhfkAfterSaveEvent extends ProcessStepTriggerEvent {

	public ShanXiZqbNhfkAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			LogUtil.getInstance().addLog(dataId, "内核反馈及回复", customername+"变更内核反馈及回复审核信息");
