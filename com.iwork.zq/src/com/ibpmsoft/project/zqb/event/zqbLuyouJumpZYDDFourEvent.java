 ...
 * 
 */
public class zqbLuyouJumpZYDDFourEvent extends SysJumpTriggerEvent {

	public zqbLuyouJumpZYDDFourEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public List<UserContext> getNextUserList() {
		...
		if (map!=null&&map.size() > 0 ) {
			...
			if (hash.get("WLINS") != null
				...
				// 有参与人取得第三个参与人员
				if (list.size() > 3) {
					if (list.get(3).get("USERID") != null) {
						String userid = list.get(3).get("USERID").toString();
