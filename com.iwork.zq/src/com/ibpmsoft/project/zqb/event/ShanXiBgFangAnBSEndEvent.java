...
public class ShanXiBgFangAnBSEndEvent extends ProcessTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiBgFangAnBSEndEvent.class);
	public ShanXiBgFangAnBSEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(!dataMap2.isEmpty()){
				...
				content.append(jyf).append("并购方案资料报审审核通过！");
