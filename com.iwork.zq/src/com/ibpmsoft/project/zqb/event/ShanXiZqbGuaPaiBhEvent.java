...
public class ShanXiZqbGuaPaiBhEvent extends ProcessStepTriggerEvent {
	
	public ShanXiZqbGuaPaiBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			LogUtil.getInstance().addLog(dataId, "挂牌登记及归档审核流程", customername+"挂牌登记及归档审核流程被驳回！");
