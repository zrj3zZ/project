...
public class ShanXiCwLiXiangEndEvent extends ProcessTriggerEvent {
	
	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiCwLiXiangEndEvent.class);
	public ShanXiCwLiXiangEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			if(!dataMap2.isEmpty()){
				...
				content.append(customername).append("一般性财务顾问项目立项审核通过！");
