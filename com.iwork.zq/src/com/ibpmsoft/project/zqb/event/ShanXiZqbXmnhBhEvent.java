...
public class ShanXiZqbXmnhBhEvent extends ProcessStepTriggerEvent {
	
	public ShanXiZqbXmnhBhEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if (dataMap != null) {
			...
			LogUtil.getInstance().addLog(dataId, "申报审核流程", customername+"申报审核流程被驳回！");
