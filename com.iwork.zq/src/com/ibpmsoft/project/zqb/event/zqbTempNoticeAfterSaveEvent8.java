 ...
 *
 */
public class zqbTempNoticeAfterSaveEvent8 extends ProcessStepTriggerEvent {
	...
	public zqbTempNoticeAfterSaveEvent8(UserContext uc, HashMap hash) {
		super(uc, hash);
...
//        		smsContent = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.ANN_ADD_KEY, map); 
        		//xlj 2017年3月9日15:08:42 提交发布版文件，短信发送改为完成审核。
        		//获取当前日期时间
        		...
        		mailContent = zqjc + "提交了公告："+dataMap.get("NOTICENAME").toString()+"的发布版文件，请求审核发布！";
