...
public class ShanXiXmnhEndEvent extends ProcessTriggerEvent {
	public ShanXiXmnhEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			content.append(dataMap.get("CUSTOMERNAME").toString()).append("申报审核通过！");
