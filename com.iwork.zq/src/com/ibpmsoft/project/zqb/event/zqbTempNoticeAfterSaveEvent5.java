 ...
 *
 */
public class zqbTempNoticeAfterSaveEvent5 extends ProcessStepTriggerEvent {
	...
	public zqbTempNoticeAfterSaveEvent5(UserContext uc, HashMap hash) {
		super(uc, hash);
...
//			smsContent = ZQBNoticeUtil.getInstance().getNoticeSmsContent(ZQB_Notice_Constants.ANN_ADD_KEY, map);
			...
			/*String useraddress5 = ZQBNoticeUtil.getInstance().getCYFZR1Customer(customerno);
			String userid = UserContextUtil.getInstance().getUserId(useraddress5);*/
