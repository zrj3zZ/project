 ...
 * 
 */
public class ShanXiZqbBgFangAnBSAfterSaveEvent extends ProcessStepTriggerEvent {

	private final static String CN_FILENAME = "/common.properties";
	private static Logger logger = Logger.getLogger(ShanXiZqbBgFangAnBSAfterSaveEvent.class);
	public ShanXiZqbBgFangAnBSAfterSaveEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
