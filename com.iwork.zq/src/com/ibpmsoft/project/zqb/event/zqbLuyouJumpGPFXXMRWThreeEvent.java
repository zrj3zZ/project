 ...
 * 
 */
public class zqbLuyouJumpGPFXXMRWThreeEvent extends SysJumpTriggerEvent {

	public zqbLuyouJumpGPFXXMRWThreeEvent(UserContext me, Task task) {
		super(me, task);
	}
	...
	public String getNextStepId() {
		if(isExists("ZZSPR")&&!isNextNode("ZZSPR")&&!isSkip("ZZSPR")){
	...
	public List<UserContext> getNextUserList() {
		...
		if (list.size() == 1) {
			if (list.get(0).get("ZZSPR") != null&&!list.get(0).get("ZZSPR").toString().equals("")&&!isNextNode("ZZSPR")&&!isSkip("ZZSPR")) {
