 ...
 *
 */
public class zqbTempNoticeAfterSaveEvent2 extends ProcessStepTriggerEvent {
	...
	public zqbTempNoticeAfterSaveEvent2(UserContext uc, HashMap hash) {
		super(uc, hash);
			...
			if("".equals(sq)||sq==null){
				...
				if(lcbsexists!=null&&lcbsexists.size()==1){
					for(HashMap<String,Object> hash:lcbsexists){
						...
						hash.put("NOTICESQ", dataMap.get("NOTICESQ")==null?"":dataMap.get("NOTICESQ").toString());
