...
public class ShanXiGzfkEndEvent extends ProcessTriggerEvent {
	public ShanXiGzfkEndEvent(UserContext uc, HashMap hash) {
		super(uc, hash);
	}
	...
	public boolean execute() {
		...
		if(dataMap!=null){
			...
			content.append(dataMap.get("CUSTOMERNAME").toString()).append("股转反馈及回复审核通过！");
