 ...
 *
 */
public class ZQB_CF_DeleteEvent  extends DemTriggerEvent {
	public ZQB_CF_DeleteEvent(UserContext me,HashMap hash){
		super(me,hash);
	}
	...
	public boolean execute() { 
		...
		LogUtil.getInstance().addLog(dataId, "挂牌企业处罚记录管理", value+"删除挂牌企业处罚记录信息");
		return true;
	}
}