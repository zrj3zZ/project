 ...
 *
 */
public class ZQB_GLF_SaveAfterEvent  extends DemTriggerEvent {
	public ZQB_GLF_SaveAfterEvent(UserContext me,HashMap hash){
		super(me,hash);
	}
	...
	public boolean execute() { 
		...
		LogUtil.getInstance().addLog(dataId, "关联方管理", "添加/修改关联方信息："+value);
		return true;
	}
}